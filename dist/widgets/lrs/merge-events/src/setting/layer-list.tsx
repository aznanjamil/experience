...
export function LrsLayerList (props: Props) {
  const { widgetId, layers = [], mapWidgetIds, portalUrl, theme, onLayersAdded, onLayerRemoved, onClearAll, onLayerChanged, onLayerOrderChanged, onMapWidgetedChanged, intl } = props
