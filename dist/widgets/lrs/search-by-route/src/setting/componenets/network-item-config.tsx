/** @jsx jsx */
import { React, jsx, css, type ImmutableObject, hooks, type IntlShape } from 'jimu-core'
...
export function NetworkItemConfig (props: Props) {
  const { intl, widgetId, index, networkItem, onNetworkItemChanged } = props
