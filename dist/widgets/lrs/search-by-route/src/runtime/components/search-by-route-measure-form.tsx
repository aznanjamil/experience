...
import { type RouteAndMeasureQuery, type NetworkItem, SearchMeasuresType, Identifiers } from '../../config'
...
export const SearchMeasureForm = React.forwardRef((props: SearchMeasureProps, ref) => {
  const { widgetId, reset, networkItem, dataSource, isDataSourceReady, intl, onSubmit, onValidationChanged } = props
