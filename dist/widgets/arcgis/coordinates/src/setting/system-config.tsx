...
import { Link, Select, Tooltip, defaultMessages as jimuiDefaultMessages, Label, Radio, Button, NumericInput, Loading, LoadingType } from 'jimu-ui'
          ...
          ? <Fragment>
            ...
            {(datumStatus || datum2Status) &&
              <SettingSection>
                ...
                {datumStatus &&
                  <Fragment>
                    <SettingRow flow='wrap' className='mt-4'>
                      {datumStatus && datum2Status &&
