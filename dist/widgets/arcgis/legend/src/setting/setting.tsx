        ...
        <div className="widget-setting-legend">
          <SettingSection
            ...
            title={this.props.intl.formatMessage({
              id: 'sourceLabel',
              defaultMessage: allDefaultMessages.sourceLabel
            })}
            role="group"
            aria-label={
          ...
          <SettingSection
            title={this.props.intl.formatMessage({
              id: 'legendMode',
              defaultMessage: allDefaultMessages.legendMode
            })}
            role="group"
            aria-label={
              this.props.intl.formatMessage({
          ...
          <SettingSection
            title={this.props.intl.formatMessage({
              id: 'options',
              defaultMessage: allDefaultMessages.options
            })}
            role="group"
            aria-label={
              this.props.intl.formatMessage({
          ...
          <SettingSection>
            ...
            >
              <Switch
                ...
                aria-label={this.props.intl.formatMessage({
                  id: 'advance',
                  defaultMessage: allDefaultMessages.advance
                })}
              />
            </SettingRow>
            <div className="mt-4" style={{ display: displayStyleContent }}>
              ...
              >
                <ThemeColorPicker
                  ...
                  aria-label={this.props.intl.formatMessage({
                    id: 'fontColor',
                    defaultMessage: allDefaultMessages.fontColor
                  })}
                />
              </SettingRow>
              <SettingRow
              ...
              >
                <ThemeColorPicker
                  ...
                  aria-label={this.props.intl.formatMessage({
                    id: 'backgroundColor',
                    defaultMessage: allDefaultMessages.backgroundColor
                  })}
                />
              </SettingRow>
            </div>
