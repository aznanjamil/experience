/** @jsx jsx */
import {
  React, ReactDOM, css, jsx, getAppStore, type AllWidgetProps, SessionManager, type DataRecordSet, TimezoneConfig,
  AppMode, type IMState, classNames, polished, ReactResizeDetector, MutableStoreManager, type IMUrlParameters
} from 'jimu-core'
    ...
    return css`
      ...
      */
      .map-component-container:fullscreen {
        ...
        /*
          case1: When map is not in real full screen mode, document.fullscreenElement is null and popper is palced into document.body. So, the popper of map tool is above map popup as expected.
      ...
      */
      ...
      /*
        ...
        To sove the above case, we need to hide the map-tool-layout of map widget1.
      */
