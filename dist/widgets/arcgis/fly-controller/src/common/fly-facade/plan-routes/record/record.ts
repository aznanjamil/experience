...
export default class Record {
  ...
  // constructor()
  async setup (recordConfig: RecordConfig, sceneView: __esri.SceneView, flyCallbacks: FlyStateChangeCallbacks, justForHightlight?: boolean): Promise<Record> {
