...
export const RotateModeSetting = React.memo((props: Props) => {
  ...
  return (
    <React.Fragment>
      <SettingRow>
        <Label className='flystyle-label'>{rotateModeTips}</Label>
      </SettingRow>
      ...
      {isAroundMapCenter && <React.Fragment>
        ...
        <SettingRow className='d-none justify-content-between mt-2'>
          ...
          <NumericInput
            ...
            value={pauseTime} defaultValue={DEFALUT_PARAMS.pauseTimeDefault}
            min={DEFALUT_PARAMS.pauseTimeMin} max={DEFALUT_PARAMS.pauseTimeMax} step={0.1} precision={1}
