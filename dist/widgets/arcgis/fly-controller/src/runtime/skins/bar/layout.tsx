          ...
          {this.props.isAroundMapCenterMode &&
            <div className='items d-flex flex-row justify-content-around'>
              ...
              {!this.props.isOnly1FlyModeInUse &&
                <div className={'setting-btns-wapper items '}>
                  <div className='item'>
          ...
          {!this.props.isAroundMapCenterMode &&
            <div className='items d-flex flex-row justify-content-around'>
              ...
              <div className='d-flex'>
                ...
                {/* 1.2 */}
                <div className={getPlayPanelWapperClass(this.props.isPlaying, this.props.isOnly1FlyModeInUse)}>
              ...
              {/* 3 */}
              <div className={'progress-bar-wapper ' + getPlayPanelWapperClass(this.props.isPlaying, this.props.isOnly1FlyModeInUse)}>
