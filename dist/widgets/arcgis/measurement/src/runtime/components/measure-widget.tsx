/** @jsx jsx */
import { React, jsx, css, AppMode, type IMState, ReactRedux, loadArcGISJSAPIModules, hooks, type IMThemeVariables } from 'jimu-core'
...
import type reactiveUtils from '@arcgis/core/core/reactiveUtils'
...
export default function MeasureWidget (props: MeasureWidgetProps): React.ReactElement {
  ...
  React.useEffect(() => {
    ...
    if (typeof curTool?.container === 'object' && curTool?.container !== null) {
      curTool.container.style.display = 'block'
    }
