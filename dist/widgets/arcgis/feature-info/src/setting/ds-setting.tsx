/** @jsx jsx */
import { React, Immutable, jsx, type UseDataSource, DataSourceComponent, type FeatureLayerDataSource, type SceneLayerDataSource } from 'jimu-core'
...
export default class DSSetting extends React.PureComponent< Props, State > {
  private readonly supportedDsTypes = Immutable([AllDataSourceTypes.FeatureLayer, AllDataSourceTypes.SceneLayer, AllDataSourceTypes.BuildingComponentSubLayer, AllDataSourceTypes.OrientedImageryLayer, AllDataSourceTypes.ImageryLayer])
