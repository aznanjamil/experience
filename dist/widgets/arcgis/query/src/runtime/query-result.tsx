...
export function QueryTaskResult (props: QueryTasResultProps) {
  ...
  React.useEffect(() => {
    ...
    MessageManager.getInstance().publishMessage(new DataRecordsSelectionChangeMessage(widgetId, []))
  ...
  const toggleSelection = React.useCallback((data: FeatureDataRecord) => {
    ...
    MessageManager.getInstance().publishMessage(new DataRecordsSelectionChangeMessage(widgetId, selectedDatas))
