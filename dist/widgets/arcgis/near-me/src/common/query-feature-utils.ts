 ...
 */
export const getALLFeatures = async (ds, queryGeometry: Geometry, returnGeometry: boolean, outSR: SpatialReference, outFields: string[]): Promise<DataRecord[]> => {
  const promise = new Promise<DataRecord[]>((resolve) => {
    if (!ds) {
      resolve([])
      return
    ...
    if (outFields === undefined) {
      ...
      //skip esriCTApproxDistance as this is a custom field generated by widget which will not be avaialble for query
