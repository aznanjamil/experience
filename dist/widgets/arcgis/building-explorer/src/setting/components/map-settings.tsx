...
export interface Props {
  ...
  activedJimuMapView: JimuMapView
  config: IMConfig
...
export const MapSettings = React.memo((props: Props) => {
  ...
  const _hasBuildingLayer = (_dataSourceId: string): boolean => {
    ...
    //const layerViews = props.activedJimuMapView?.getAllJimuLayerViews()
  ...
  const getCurrentLayerViews = React.useCallback((): JimuLayerView[] => {
    ...
    return getBuildingLayerViewsByLayerViewIds(currentSetting.layersOnLoad ?? Immutable[''], props.activedJimuMapView)
  }, [props.activedJimuMapView, //currentDSIdState,
            ...
            sidePopperContent={
              ...
              <SettingSection>
                ...
                <SettingRow className='mt-2'>
                  {
                    (props.activedJimuMapView) && <Select value={getSelectedLayerView()?.id} onChange={handleSelectedLayer}
