...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  }, [id, jimuMapView?.view, searchConfig, routeConfig?.useUtility, defaultSearchHint, isReadyToRender, isDarkTheme, props.autoHeight, updateFromDataAction, utilitiesChangedFlag])
