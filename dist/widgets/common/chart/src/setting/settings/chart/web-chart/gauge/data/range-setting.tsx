...
import { defaultMessages as jimlayoutDefaultMessage } from 'jimu-layouts/layout-runtime'
...
export const RangeSetting = (props: RangeSettingProps) => {
  const translate = hooks.useTranslation(defaultMessages, jimuiDefaultMessage, jimlayoutDefaultMessage)
