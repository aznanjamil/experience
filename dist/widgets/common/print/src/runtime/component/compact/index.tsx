...
import { type IMConfig, type PrintTemplateProperties, type IMPrintTemplateProperties, type IMPrintResultListItemTyle, PrintResultState, type MapView, type OutputDataSourceWarningOption } from '../../../config'
...
const CompactPrint = (props: Props) => {
  const { config, templateList, jimuMapView, errorTip, id, locale, useMapWidgetIds, outputDataSourceWarning, showPlaceholder, showUtilityErrorRemind, toggleUtilityErrorRemind } = props
      ...
      >
        {!showPlaceholder && <div className='d-flex flex-column w-100 h-100'>
          ...
          <div className='flex-grow-1'>
            ...
            {showResult && <PrintResult prinResult={printResult} restPrint={restPrint} useUtility={config?.useUtility}/>}
          </div>
        </div>}
