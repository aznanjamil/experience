...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig> & ExtraProps, State> {
  ...
  getStyle () {
    const { useAspectRatio } = this.props
    ...
    return css`
      ...
      .image-gallery-button {
        ...
        width: 24px;
        height: 24px;
        background-color: ${polished.rgba(this.props.theme.ref.palette.white, 0.5)};
      }
      .image-gallery-button:hover {
        background-color: ${this.props.theme.ref.palette.white};
      }
    `
  }
