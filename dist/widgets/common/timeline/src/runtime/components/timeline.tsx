...
function TimeLine (props: TimelineProps) {
  ...
  React.useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [_autoPlay, enablePlayControl, startTime, cumulatively, endTime, accuracy, stepLength, dividedCount])
          ...
          : <React.Fragment>
            ...
            <div className='timeline-content'>
              ...
              <div className='timeline-middle'>
                {
                  showLeftArrow && <Button icon type='tertiary' size='sm' className={classNames('timeline-arrow left-arrow', { 'no-play-container': !enablePlayControl })}
                ...
                {
                  showRightArrow && <Button icon type='tertiary' size='sm' className={classNames('timeline-arrow right-arrow', { 'no-play-container': !enablePlayControl })}
