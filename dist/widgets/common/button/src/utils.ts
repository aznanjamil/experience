import { type ThemeButtonType, type IconProps, type IMThemeVariables, Immutable } from 'jimu-core'
import { styleUtils } from 'jimu-ui'

export function getIconPropsFromTheme (isRegular: boolean, type: ThemeButtonType, theme: IMThemeVariables): IconProps {
