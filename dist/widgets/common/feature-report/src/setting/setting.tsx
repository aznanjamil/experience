  ...
  render () {
    ...
    <Fragment>
      <Alert
        ...
        withIcon
      />
      <SettingSection role='group' className={useDataSource ? '' : 'border-0'} title={this.i18n('data')}>
    ...
    const templateSettingSection = (
      // <div className='template-setting-outter'>
        <SettingSection role='group' className={'template-setting-outter'}>
              ...
              <ModalBody>
                <div className='px-2 py-0 template-list'>
                  <p className='font-13 font-dark-600 mt-4'>
                    ...
                    <a href={'https://doc.arcgis.com/' + (this.props.locale || 'en') + '/survey123/browser/analyze-results/featurereporttemplates.htm'} target='_blank'>
                      {this.i18n('reportTemplateHelpLearnMore')}
                      </a>
                  </p>
                  <p className='font-14 font-dark-800 mt-4'>
                    {this.i18n('quickReferencePage')}
                    <a href={this.state.quickReferenceUrl} target='_blank'>
          ...
          <SettingRow>
            <Button type="primary" className="w-100 add-template-btn" onClick={() => { this.openTemplateEditor(this.state.seletedTemplateItems.length) }}>
    ...
    const configSection =
      <div className='option-setting-outter'>
        <SettingSection title={this.i18n('configration')}>
          <SettingRow>
