  ...
  return (
      <SettingRow css={getStyle(theme)}>
          <div className='w-100 option-setting'>
            <p>{translate('reportTemplateTip')}</p>
            <div css={css('position:relative;')}>
              <ul>
                <li>
                  ...
                  <Tooltip title={translate('individualRecordTemplateTip')} placement='left' interactive={true} >
                    <span>
                      <InfoOutlined />
                    </span>
                  </Tooltip>
                ...
                <li>
                  ...
                  <Tooltip title={translate('summaryTemplateTip')} placement='left' interactive={true} >
                    <span>
                      <InfoOutlined />
                    </span>
                  </Tooltip>
                ...
                <li>
                  ...
                  <Tooltip title={translate('combinedTemplateTip')} placement='left' interactive={true} >
                    <span>
                      <InfoOutlined />
                    </span>
                  </Tooltip>
