...
import { b as slotChangeHasAssignedElement, e as getSlotted, t as toAriaBoolean } from './dom-8c012086.js';
...
import { c as componentFocusable, a as setComponentLoaded, s as setUpLoadableComponent } from './loadable-d76fe6f4.js';
    ...
    render() {
        ...
        const role = this.selectionMode === "multiple"
            ...
            : this.selectionMode !== "none"
                ? "radio"
                : undefined;
        return (h(Host, { key: '8fa8f2d7e3ff03d01d746fd00236958a910cc60b' }, h(InteractiveContainer, { key: 'f1a65dcd2389a060c9de2ab0d9ee9b4ab23609f9', disabled: this.disabled }, h("div", { key: '093dc24588252efa9ce7f58cbd6791f9010ab9b9', "aria-checked": this.selectionMode !== "none" ? toAriaBoolean(this.selected) : undefined, "aria-disabled": this.disabled, "aria-label": this.label, class: { [CSS.contentWrapper]: true, inline: thumbnailInline }, onClick: this.cardBodyClickHandler, onKeyDown: this.keyDownHandler, role: role, tabIndex: !this.selectable || this.disabled ? 0 : -1,
            // eslint-disable-next-line react/jsx-sort-props
            ref: (el) => (this.containerEl = el) }, this.loading ? (h("div", { "aria-live": "polite", class: "calcite-card-loader-container" }, h("calcite-loader", { label: this.messages.loading }))) : null, thumbnailStart && this.renderThumbnail(), h("section", { key: 'efe0f6b35e6e4ed6ceacd4e9d0e7879e9527e331', "aria-busy": toAriaBoolean(this.loading), class: { [CSS.container]: true } }, this.renderHeader(), h("div", { key: 'd74667dc72d6320d3d97ff6b386f1659d53174f5', class: {
                [CSS.cardContent]: true,
                [CSS.hasSlottedContent]: this.hasContent,
            } }, h("slot", { key: 'dbcd8cb5f7979f33a93810dd38124b10c8174b43', onSlotchange: this.handleDefaultSlotChange })), this.renderFooter()), !thumbnailStart && this.renderThumbnail()))));
    }
