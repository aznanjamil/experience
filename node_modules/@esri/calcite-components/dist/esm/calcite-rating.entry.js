...
import { f as focusFirstTabbable } from './dom-8c012086.js';
...
const Rating = class {
    ...
    render() {
        return (h(Host, { key: 'a52cda8c257cd7d890f2828228c22e6f55da6ec8', onKeyDown: this.handleHostKeyDown, onPointerOut: this.handleRatingPointerOut, onPointerOver: this.handleRatingPointerOver }, h(InteractiveContainer, { key: 'd600bf2953778bfd2b934c64afecec1075f4092a', disabled: this.disabled }, h("span", { key: 'fe31c08304e6ba4426aaf56fdfbd3cc660f364fc', class: "wrapper" }, h("fieldset", { key: '090ccda26e6043bee537571a459df82342d416df', class: "fieldset", disabled: this.disabled }, h("legend", { key: '844a839881be1428b098db9da2d462c48a218b1b', class: "visually-hidden" }, this.messages.rating), this.starsMap.map(({ average, checked, fraction, hovered, id, partial, selected, value, tabIndex, }) => {
        ...
        }), (this.count || this.average) && this.showChip ? (h("calcite-chip", { scale: this.scale, value: this.count?.toString() }, !!this.average && h("span", { class: "number--average" }, this.average.toString()), !!this.count && h("span", { class: "number--count" }, "(", this.count?.toString(), ")"))) : null), h(HiddenFormInputSlot, { key: 'a01bb6f3aae187ccacbb31607f259e9de5ce90aa', component: this })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
