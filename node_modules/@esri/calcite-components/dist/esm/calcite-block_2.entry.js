...
import { f as focusFirstTabbable, e as getSlotted, t as toAriaBoolean, g as getElementDir } from './dom-8c012086.js';
...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (h("header", { key: 'aefae50b975f87b21c9b37f7eae2df49062ee5f8', class: CSS$1.header, id: IDS$1.header }, this.renderIcon(), this.renderTitle()));
        const hasControl = !!getSlotted(el, SLOTS.control);
        const hasMenuActions = !!getSlotted(el, SLOTS.headerMenuActions);
        const collapseIcon = open ? ICONS$1.opened : ICONS$1.closed;
        const headerNode = (h("div", { key: 'f8c5ce075f5d83e483ee3d2d62fd187fd0987b30', class: CSS$1.headerContainer }, this.dragHandle ? h("calcite-handle", { label: heading }) : null, collapsible ? (h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? toAriaBoolean(open) : null, class: CSS$1.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, h("calcite-icon", { "aria-hidden": "true", class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" }))) : (headerContent), hasControl ? (h("div", { class: CSS$1.controlContainer }, h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (h("calcite-action-menu", { label: messages.options, overlayPositioning: this.overlayPositioning }, h("slot", { name: SLOTS.headerMenuActions }))) : null));
        return (h(Host, { key: '8e984813d8283475171ad0b58bb77c6671da394c' }, h(InteractiveContainer, { key: '9757aa3d3d51eeca2eece6b7fcf1ed2bdbc9d4eb', disabled: this.disabled }, h("article", { key: '6722572eb61cf147e473bd237bff74bafde0af56', "aria-busy": toAriaBoolean(loading), class: {
                [CSS$1.container]: true,
            } }, headerNode, h("section", { key: '14a1118f4b8a7d3f8ddc063cbcd2ba062090973a', "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content,
