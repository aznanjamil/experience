 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-084e6474.js';
import { j as getDaysDiff, c as dateToISO, e as dateFromISO, g as getValueAsDateRange, h as dateFromRange, f as getLocaleData, s as setEndOfDay, k as sameDate, i as inRange, l as getOrder, n as nextMonth, p as prevMonth, m as formatCalendarYear, o as parseCalendarYear } from './utils-9a3ce99f.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-d76fe6f4.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter, e as getDateTimeFormat } from './locale-3bacb738.js';
import { c as connectMessages, d as disconnectMessages, s as setUpMessages, u as updateMessages } from './t9n-639aa12c.js';
import { a as closestElementCrossShadowBoundary, t as toAriaBoolean } from './dom-8c012086.js';
import { I as InteractiveContainer, c as connectInteractive, u as updateHostInteraction, d as disconnectInteractive } from './interactive-8e4cb61e.js';
    ...
    render() {
        ...
        const maxDate = this.range && this.activeRange
            ? this.activeRange === "start"
                ...
                : this.maxAsDate
            : this.maxAsDate;
        return (h(Host, { key: 'af94b669a3045e53c100cb5850381e9f77423133', onBlur: this.resetActiveDates, onKeyDown: this.keyDownHandler }, this.renderCalendar(activeDate, maxDate, minDate, date, endDate)));
    }
...
const DatePickerDay = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8de3dbeb652bfeb5ea9e9a490c3cec6a3663aeea', "aria-disabled": toAriaBoolean(this.disabled), "aria-label": dayLabel, "aria-selected": toAriaBoolean(this.active), id: dayId, onClick: this.onClick, onKeyDown: this.keyDownHandler, role: "button", tabIndex: this.active && !this.disabled ? 0 : -1 }, h(InteractiveContainer, { key: 'edb52f389027ea4f48067e2c0a4c6a28251bc4ab', disabled: this.disabled }, h("div", { key: 'fd75d2ebcd2e6ca21afdefb3f4e6f02089b43609', "aria-hidden": "true", class: { "day-v-wrapper": true } }, h("div", { key: 'd4ac04c544b7f26c1e1992f4b8046c608c6174cd', class: "day-wrapper" }, h("span", { key: '8453fd6dd54fa642f1779b99e2f1012a2277cfda', class: "day" }, h("span", { key: 'fb704e33e0d0af0ce76988983b530e640a361299', class: "text" }, formattedDay)))))));
    }
    connectedCallback() {
...
const DatePickerMonthHeader = class {
    ...
    render() {
        return h("div", { key: '9e392da76cbe365de812b6219b3ee7ada90a09e6', class: CSS.header }, this.renderContent());
    }
    renderContent() {
