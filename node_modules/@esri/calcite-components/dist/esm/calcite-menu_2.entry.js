 ...
 * v2.8.5
 */
import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement, c as createEvent, F as Fragment } from './index-084e6474.js';
import { s as slotChangeGetAssignedElements, k as focusElementInGroup, d as focusElement, g as getElementDir } from './dom-8c012086.js';
...
const CalciteMenu = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '669e13e4abc6cbb425226bd6e7d25f83f0283eab' }, h("ul", { key: 'd6b5858ea4e4935a7f789c2ed9b40432baa28e7e', "aria-label": this.label, role: this.getEffectiveRole() }, h("slot", { key: '5e72015f3b6c1f81dabe0ada164d105d1bda82e4', onSlotchange: this.handleMenuSlotChange }))));
    }
...
const CalciteMenuItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a84ca1769bc08137a7defbea5e10ee12a78fbd58', onBlur: this.blurHandler, onFocus: this.focusHandler }, h("li", { key: '88d13dda176ed2821b59505a6866b98b88f47f9b', class: {
                [CSS.container]: true,
                [CSS.isParentVertical]: this.topLevelMenuLayout === "vertical",
            }, role: "none" }, h("div", { key: '185265194184e457cfc1d578bee3b8c5e02d45b3', class: CSS.itemContent }, h("a", { key: '456bbee5f9af53b51951c57b355b0696fa76fff7', "aria-current": this.isFocused ? "page" : false, "aria-expanded": this.open, "aria-haspopup": this.hasSubmenu, "aria-label": this.label, class: { [CSS.layoutVertical]: this.layout === "vertical", [CSS.content]: true }, href: this.href, onClick: this.clickHandler, onKeyDown: this.keyDownHandler, rel: this.rel, role: "menuitem", tabIndex: this.isTopLevelItem ? 0 : -1, target: this.target,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
