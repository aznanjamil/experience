 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, e as readTask, F as Fragment } from './index-084e6474.js';
import { B as nodeListToArray, k as focusElementInGroup, g as getElementDir, C as filterDirectChildren, t as toAriaBoolean } from './dom-8c012086.js';
import { g as guid } from './guid-71ff9371.js';
import { a as calciteSize24, b as calciteSize32, d as calciteSize44 } from './core-2d4b669f.js';
...
import { c as connectInteractive, d as disconnectInteractive, I as InteractiveContainer, u as updateHostInteraction } from './interactive-8e4cb61e.js';
...
const Tab = class {
    ...
    render() {
        ...
        return (h(Host, { key: '71074d2c26a860d7934fbd9b236f9a264ab3c34f', "aria-labelledby": this.labeledBy, id: id }, h("div", { key: '3fcf14f4aaddf9ad579c26c962ad75803febcea0', class: { [CSS$2.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, h("section", { key: 'ba967be2e5121636d81754ec959452160bc4bb0d', class: CSS$2.content }, h("slot", { key: 'fae921d6fe2ae713bddc83adacbcf7e418aa1b7c' })))));
    }
    connectedCallback() {
...
const TabNav = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0824dd4470393b0e186b0fdf238420454fed396c', role: "tablist" }, h("div", { key: '205551441feaaa61e2b4b603a7b37ce3d18bdba8', class: {
            ...
            ref: this.storeContainerRef }, this.renderScrollButton("start"), h("div", { key: '64844ffd05363fe55e2ae9d4d820dc5113da57d8', class: {
                [CSS$1.tabTitleSlotWrapper]: true,
            }, onScroll: this.onTabTitleScroll, onWheel: this.onTabTitleWheel,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeTabTitleWrapperRef }, h("slot", { key: 'a77b898cac87d4fa190ad717a3c0ca4474a962fe', onSlotchange: this.onSlotChange })), h("div", { key: '0bf812fe39d07fbddd54ddb515e2eb31adea9a74', class: {
                [CSS$1.activeIndicatorContainer]: true,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.activeIndicatorContainerEl = el) }, h("div", { key: 'e1624e7b9845ea37eea06ca7a85816d782530c79', class: "tab-nav-active-indicator", style: indicatorStyle,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: 'dc31a68fd20ffcf451d5b23e2aaae683249aa50a', class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: getIconScale(this.scale) }));
        const iconEndEl = (h("calcite-icon", { key: 'b8b85c799e950e050bb6c953cec61ab871894c9c', class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: getIconScale(this.scale) }));
        return (h(Host, { key: '532a18e093cd481a1058e55f1ac936489cad3ddb', "aria-controls": this.controls, "aria-selected": toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, h(InteractiveContainer, { key: 'dede575160963d2463e50f6e8baab92319acda9f', disabled: this.disabled }, h("div", { key: '79e9c6d5f15626cd84101e7b85365c9af2c1453b', class: {
                container: true,
                [CSS.iconPresent]: !!this.iconStart || !!this.iconEnd,
                [`scale-${this.scale}`]: true,
            }, hidden: closed,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => this.resizeObserver?.observe(el) }, h("div", { key: '8076d17c92940370363d9bc1dae416fdcdf4b716', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, h("slot", { key: 'b25df3722162e58cb196ca500a7b4c718d5f2ed7' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton()))));
    }
    renderCloseButton() {
...
const Tabs = class {
    ...
    render() {
        return (h(Fragment, { key: '3298379f9625744b770c10f0f86fc1b2bc990cad' }, h("slot", { key: 'fd0be78d348a01b701d58f37663d392ee04ca6a9', name: SLOTS.titleGroup }), h("section", { key: '31212d582a0e6367ed38d250c1acc39cad3fa987' }, h("slot", { key: '179bdacefed784c60dd000101e606d5e678d93c9' }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
