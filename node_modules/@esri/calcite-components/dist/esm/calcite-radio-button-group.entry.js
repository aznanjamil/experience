...
const RadioButtonGroup = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '2fb0413488832f3bd449c5bb41d31e088c82ab11', role: "radiogroup" }, h("div", { key: '92b23646b20efa340d8368455bc2c2e2c3dce0f5', class: CSS.itemWrapper }, h("slot", { key: '19f6211227d8d4fb003a1535a1948b7da2b4810e' })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
