...
import { k as focusElementInGroup } from './dom-8c012086.js';
...
const TableRow = class {
    ...
    render() {
        return (h(Host, { key: '1d51f5351ce604d34d7b5a8c6ff241d1f1bb7121' }, h(InteractiveContainer, { key: '67d835df1a6a91ebddd1742f76bdf45407bce5e5', disabled: this.disabled }, h("tr", { key: 'b490313209717e71bb18e277d6795895e7f60a25', "aria-disabled": this.disabled, "aria-rowindex": this.positionAll + 1, "aria-selected": this.selected, class: { [CSS.lastVisibleRow]: this.lastVisibleRow }, onKeyDown: this.keyDownHandler,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.tableRowEl = el) }, this.numbered && this.renderNumberedCell(), this.selectionMode !== "none" && this.renderSelectableCell(), h("slot", { key: 'ca447805a4b4a807ee113fd438fca4fe95a6b6c6', onSlotchange: this.updateCells,
