...
import { f as filterComputedPlacements, c as connectFloatingUI, b as defaultOffsetDistance, a as disconnectFloatingUI, r as reposition, F as FloatingCSS } from './floating-ui-53bb7346.js';
...
import { x as isKeyboardTriggeredClick, t as toAriaBoolean, f as focusFirstTabbable, q as queryElementRoots } from './dom-8c012086.js';
...
import { F as FloatingArrow } from './FloatingArrow-fff14694.js';
...
const Popover = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9699189cce66b9eac663b521b33e0d74c07f271b', "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { key: 'ad5a31d83091be7486973e36f2e360fdd0cee060', class: {
                [FloatingCSS.animation]: true,
                [FloatingCSS.animationActive]: displayed,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, arrowNode, h("div", { key: '4857f90f555b3b9057d39462f875265dbaa3cc7b', class: {
                [CSS.hasHeader]: !!heading,
                [CSS.container]: true,
            } }, this.renderHeader(), h("div", { key: 'a09083a06be92110adf34b178af162b387ccfb2f', class: CSS.content }, h("slot", { key: 'a9302486bd61e40e9d68a896965296d634f95f77' })), !heading ? this.renderCloseButton() : null))));
    }
