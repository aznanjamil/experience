 ...
 * v2.8.5
 */
import { h, r as registerInstance, c as createEvent, H as Host, e as readTask, g as getElement } from './index-084e6474.js';
import { s as slotChangeGetAssignedElements, k as focusElementInGroup } from './dom-8c012086.js';
import { c as createObserver } from './observers-128a4167.js';
import { g as guid } from './guid-71ff9371.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-3bacb738.js';
...
const Stepper = class {
    ...
    render() {
        return (h(Host, { key: '00695fed43575595fcca8adac07588de79f14170', "aria-label": this.messages.label, role: "region" }, h("div", { key: '3b06715dc1220048bdab4743e783fb28a8da001e', class: { container: true, [CSS$2.singleView]: this.layout === "horizontal-single" },
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: this.setContainerEl }, this.layout === "horizontal-single" && (h("div", { key: 'd14afc0d2ae03ea603a5c3a05157825f3dcbcc43', class: { [CSS$2.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), this.layout === "horizontal-single" && (h("div", { key: 'a83ca9efc86407ab66d895027ff3a6b9d4ab698f', class: { [CSS$2.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), h("slot", { key: '104b16d7e23e4ec0977d2934906ea83ffcd7f4cc', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (h(Host, { key: 'cbdfe76eb5b7985cf70b86d2bc5b836bc8d75498', "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler, tabIndex: this.disabled ? -1 : 0 }, h(InteractiveContainer, { key: '7f5296807f7a2e68fbcac907664f5e1a1cec63e7', disabled: this.disabled }, h("div", { key: '4b26e6d65f787c2a3d551ede9e6b939c70285493', class: CSS.container }, this.complete && (h("span", { key: 'a6c153e3e803e7d00d79cb723581c887d6b244fd', "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), h("div", { key: 'e36628ff97b54239ec2ac2751cc19afca648317b', class: CSS.stepperItemHeader, tabIndex: 
            /* additional tab index logic needed because of display: contents */
            this.layout === "horizontal" && !this.disabled ? 0 : null,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.headerEl = el) }, this.icon ? this.renderIcon() : null, this.numbered ? (h("div", { class: CSS.stepperItemNumber }, this.renderNumbers(), ".")) : null, h("div", { key: '2b76b746cd911913c982871b2d2ef65357645c31', class: CSS.stepperItemHeaderText }, h("span", { key: '3ee0d3499c9348294016e27ccc178b65fa7fa0df', class: CSS.stepperItemHeading }, this.heading), h("span", { key: '87a1ad7d0070c946ccb64847698c41d84e328937', class: CSS.stepperItemDescription }, this.description))), h("div", { key: '0e12cbcbd9aadbfe498985eaa038d1b4c68e3512', class: CSS.stepperItemContent }, h("slot", { key: 'ae4f822110e61e19f60d2bad71900632220a2594' }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
