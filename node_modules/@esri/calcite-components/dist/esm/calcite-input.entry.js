 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-084e6474.js';
import { e as getSlotted, l as isPrimaryPointerButton, h as setRequestedIcon, g as getElementDir } from './dom-8c012086.js';
import { s as submitForm, c as connectForm, i as internalHiddenInputInputEvent, d as disconnectForm, H as HiddenFormInputSlot } from './form-4b51b128.js';
...
import { n as numberStringFormatter, i as isValidNumber, p as parseNumberString, s as sanitizeNumberString, a as addLocalizedTrailingDecimalZeros, c as connectLocalized, d as disconnectLocalized, B as BigDecimal } from './locale-3bacb738.js';
import { c as createObserver } from './observers-128a4167.js';
import { C as CSS_UTILITY } from './resources-91914bfd.js';
import { u as updateMessages, c as connectMessages, d as disconnectMessages, s as setUpMessages } from './t9n-639aa12c.js';
import { g as getIconScale } from './component-320e2e16.js';
import { V as Validation } from './Validation-18c00041.js';
import { s as syncHiddenFormInput } from './input-ef30a792.js';
...
const Input = class {
    ...
    render() {
        ...
        const loader = (h("div", { key: 'b8611c67559682fd64ded80a0beddbd052f6fe2f', class: CSS.loader }, h("calcite-progress", { key: '84c686cba5249dae749bb44955e9a213cbed4943', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: 'a87ff81e4d8c269d2a223c773f7d5c0fb0216690', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '2f88616c3cc07201c049d25ee032bd819d1f14f1', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: '536bc3560e1cb98bc9ec48c88396bf947b5ec341', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (h("button", { key: 'f1aa09c7c05fbc66df54e8e655f2fbad0e8b962c', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '12b3fd28215d661525be63f614411287aa08e0fb', icon: "chevron-up", scale: getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (h("button", { key: '3e57ba83119f351060ed012fe4332a56dfd991d4', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'daf34d239d12e945aa623ed5b36e8d17e9a2e5d6', icon: "chevron-down", scale: getIconScale(this.scale) })));
        const numberButtonsVertical = (h("div", { key: '7301bb025d47c2137cfed412c1fb576fed9a2095', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = h("div", { key: '11dc889ef37e67ee0f0f73e54b7ce27eef7d88be', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: 'ddb9a1f7ebae815d2cf0d3c79ba3703f244c1c84', class: CSS.suffix }, this.suffixText);
        ...
        const childEl = this.type !== "number"
            ...
            : null;
        return (h(Host, { key: 'd85f76e488d456eb0a7c2ae9bc7daf195463409a', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '3289a4cad3353bf744476144c493b25b2fd21e55', disabled: this.disabled }, h("div", { key: '70c56455cf02bff933428c63499a4c05d49849e7', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, h("div", { key: 'a6d9a32e41dd867c9f2284a16c55188c3d8024c7', class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: 'dff205b764e3f8818a3ff8b2e68fbad387aab0b1', class: CSS.actionWrapper }, h("slot", { key: '1d10788964cace3ea9f87db3b67f1d51a174218d', name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
            ? numberButtonsVertical
            : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, h(HiddenFormInputSlot, { key: 'f551976332e2fb77ed861b2d744e67939e88c211', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
