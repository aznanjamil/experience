...
import { e as getSlotted, b as slotChangeHasAssignedElement, f as focusFirstTabbable, w as ensureId } from './dom-8c012086.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap, u as updateFocusTrapElements } from './focusTrapComponent-6139276a.js';
...
import { s as setUpMessages, c as connectMessages, d as disconnectMessages, u as updateMessages } from './t9n-639aa12c.js';
...
const Modal = class {
    ...
    render() {
        return (h(Host, { key: 'b7f4d97818454e50db3870714f97cc626b97dd33', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, h("div", { key: '721d5a12fdfcc99dc9dba820b17cd7ffecd9d0b1', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.slottedInShell]: this.slottedInShell,
            } }, h("calcite-scrim", { key: '842588afb9d19ec36a355277ba06b8cb1a454ba3', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), h("div", { key: 'b98514b2ef65856b94cca345285785fc0b056f45', class: {
                [CSS.modal]: true,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, h("div", { key: 'fdbe8abc670bd2889c05ccd6597f485bc0c0b135', class: CSS.header }, this.renderCloseButton(), h("header", { key: 'd956c14a762c22d13920e0e34b11fc8bc1b9305b', class: CSS.title }, h("slot", { key: 'd7dcd4a9a4e2029a8e5961519538aeaad6092942', name: CSS.header }))), this.renderContentTop(), h("div", { key: '5b3fd60ed69388e2b001bd188be169c86f5d40db', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.modalContent = el) }, h("slot", { key: '84a4dbeb3d1188c3f9c5b7877bf751f735262a87', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
