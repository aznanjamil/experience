...
import { a as setComponentLoaded, s as setUpLoadableComponent, c as componentFocusable } from './loadable-d76fe6f4.js';
...
const InputNumber = class {
    ...
    render() {
        ...
        const loader = (h("div", { key: 'fab2666adcf8baf1fc6580cb287668f171f0afbb', class: CSS.loader }, h("calcite-progress", { key: '03c73149b1548ad5b02e28ed9111fe07ec4742e2', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: '235835dd4bc67454ae87548fd69f596b203e0014', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '1255f76c49bb9c0cc26f3cfbf948471d904f709e', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: 'c08a14c7003e586f1b7a17e01c35c722455e7276', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (h("button", { key: 'cc75dbe00e2b3f892070dd7be2ac3c9f4b56cf28', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '1713a9e47e2713ecfb65e9957b8da94ad090dad2', icon: "chevron-up", scale: getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (h("button", { key: '7c82850c77354a92bfa48d5f85cb0f5fa2f066d7', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'a155879a7bfcdb4534334d5534f5a837562e0688', icon: "chevron-down", scale: getIconScale(this.scale) })));
        const numberButtonsVertical = (h("div", { key: '25e3626b8915e798fe5dd8ecc44289c515565a81', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = h("div", { key: '6fe6cdc9b0ce6d39c177047a91ff312a24a99a96', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: '849efbf098bc6da8afa1de6c445f17e0d4dc1aa2', class: CSS.suffix }, this.suffixText);
        ...
        return (h(Host, { key: '2c6939b012ccd0fa9f27bf13bb765c35d1752cec', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: 'b1bdb7fe28d7b89b7b08188c3dd65000720b616a', disabled: this.disabled }, h("div", { key: 'd7f11dcadb05026dcb5e197608703d4a53404075', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, h("div", { key: 'd9e1a655f0078ad7e3a3227cbc70e906d66e0a49', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: '25dfa18491488c5448adfefe87ba3f69c7930c1a', class: CSS.actionWrapper }, h("slot", { key: '500f1b272811d6c4c003afb40f5d7c0a0a222355', name: SLOTS.action })), this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, h(HiddenFormInputSlot, { key: '9b3e051eadfff57ed9f4dd14cb3e50c1830b560b', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
