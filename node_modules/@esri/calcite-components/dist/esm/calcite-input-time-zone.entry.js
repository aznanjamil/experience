...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-8e4cb61e.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-3bacb738.js';
    ...
    if (mode === "offset") {
        if (!timeZoneGroups) {
            timeZoneGroups = Promise.all([
                import('./index-36cf2614.js'),
                import('./index-71a33675.js'),
            ]);
        }
...
const InputTimeZone = class {
    ...
    render() {
        ...
        })), h(HiddenFormInputSlot, { key: '9be196de8ecde0e10e293cd49b778ce52e75a131', component: this }))));
    }
