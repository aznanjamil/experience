 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-084e6474.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-4b51b128.js';
import { g as guid } from './guid-71ff9371.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction, I as InteractiveContainer } from './interactive-8e4cb61e.js';
import { n as numberKeys } from './key-d339e1f0.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-43c2e846.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-d76fe6f4.js';
import { n as numberStringFormatter, e as getDateTimeFormat, i as isValidNumber, b as getSupportedNumberingSystem, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-3bacb738.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-6139276a.js';
import { d as decimalPlaces, g as getDecimals } from './math-400a5b13.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-639aa12c.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-a22be3a1.js';
import { g as getIconScale } from './component-320e2e16.js';
import { V as Validation } from './Validation-18c00041.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./ar-7ba88165.js')],
    ["bg", () => import('./bg-1cc907e5.js')],
    ["bs", () => import('./bs-39bfd2d0.js')],
    ["ca", () => import('./ca-1310c4b3.js')],
    ["cs", () => import('./cs-b6a446e0.js')],
    ["da", () => import('./da-cd951971.js')],
    ["de", () => import('./de-2ab70b8d.js')],
    ["de-at", () => import('./de-at-3e8d4eaa.js')],
    ["de-ch", () => import('./de-ch-573842cf.js')],
    ["el", () => import('./el-58956644.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./en-au-bd082307.js')],
    ["en-ca", () => import('./en-ca-3de639a5.js')],
    ["en-gb", () => import('./en-gb-f1bb4737.js')],
    ["es", () => import('./es-559fc2f0.js')],
    ["es-mx", () => import('./es-mx-2029da3d.js')],
    ["et", () => import('./et-a66db59a.js')],
    ["fi", () => import('./fi-fedb99f2.js')],
    ["fr", () => import('./fr-948427f9.js')],
    ["fr-ch", () => import('./fr-ch-1b5a0f1b.js')],
    ["he", () => import('./he-4d52944d.js')],
    ["hi", () => import('./hi-117e59ee.js')],
    ["hr", () => import('./hr-3c831c67.js')],
    ["hu", () => import('./hu-da297628.js')],
    ["id", () => import('./id-6eaa26ea.js')],
    ["it", () => import('./it-fae4e62a.js')],
    ["it-ch", () => import('./it-ch-5b97f332.js')],
    ["ja", () => import('./ja-3f275df3.js')],
    ["ko", () => import('./ko-d657a0a0.js')],
    ["lt", () => import('./lt-b7267978.js')],
    ["lv", () => import('./lv-ee6877be.js')],
    ["mk", () => import('./mk-b5057930.js')],
    ["nl", () => import('./nl-88da5298.js')],
    ["nb", () => import('./nb-d563c6a4.js')],
    ["pl", () => import('./pl-b8402ff9.js')],
    ["pt", () => import('./pt-8619b4f2.js')],
    ["pt-br", () => import('./pt-br-8b8a730f.js')],
    ["ro", () => import('./ro-f2146eaf.js')],
    ["ru", () => import('./ru-e50abd41.js')],
    ["sk", () => import('./sk-054caf96.js')],
    ["sl", () => import('./sl-76c80ec6.js')],
    ["sr", () => import('./sr-36f88835.js')],
    ["sv", () => import('./sv-d996e61d.js')],
    ["th", () => import('./th-6263fe9f.js')],
    ["tr", () => import('./tr-5424e2c2.js')],
    ["uk", () => import('./uk-17fec30c.js')],
    ["vi", () => import('./vi-ca8dbe7f.js')],
    ["zh-cn", () => import('./zh-cn-f459bc2d.js')],
    ["zh-hk", () => import('./zh-hk-487dd5da.js')],
    ["zh-tw", () => import('./zh-tw-d1af25c7.js')],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '561e33708dcc90afdba91d4072b7979ff11f79c7', onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '19c3360f4640bce039a46d8cb06a8927855bf13c', disabled: this.disabled }, h("div", { key: 'e48f09d0b5179e75e55cc9664f880bd350543d6a', class: "input-wrapper", onClick: this.onInputWrapperClick }, h("calcite-input-text", { key: '717afb03fbcf590ebf927fe4bd0005a00e5fe2ec', "aria-autocomplete": "none", "aria-haspopup": "dialog", disabled: disabled, icon: "clock", id: this.referenceElementId, label: getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, role: "combobox", scale: this.scale, status: this.status,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setInputAndTransitionEl }), !this.readOnly && this.renderToggleIcon(this.open)), h("calcite-popover", { key: 'd62bfe8b3ddc24e012d84b61a05061a09e6322dd', focusTrapDisabled: true, id: dialogId, label: messages.chooseTime, lang: this.effectiveLocale, onCalcitePopoverClose: this.popoverCloseHandler, onCalcitePopoverOpen: this.popoverOpenHandler, open: this.open, overlayPositioning: this.overlayPositioning, placement: this.placement, referenceElement: this.referenceElementId, triggerDisabled: true,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setCalcitePopoverEl }, h("calcite-time-picker", { key: '6bfcee7272942b5476486a86933376b81aff7b23', lang: this.effectiveLocale, messageOverrides: this.messageOverrides, numberingSystem: this.numberingSystem, onCalciteInternalTimePickerChange: this.timePickerChangeHandler, scale: this.scale, step: this.step, tabIndex: this.open ? undefined : -1, value: this.value,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setCalciteTimePickerEl })), h(HiddenFormInputSlot, { key: '0ca8c8c04ef40e120530a4666761473b8d1b987f', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const TimePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: 'a14cbeb1861fce5acdb6c06210c62d1a60e2c7e7', class: {
                [CSS.timePicker]: true,
                [CSS.showMeridiem]: showMeridiem,
                [CSS.showSecond]: this.showSecond,
                [CSS[`scale-${this.scale}`]]: true,
            }, dir: "ltr" }, h("div", { key: 'a53db9fc5411776df398bdf4df8a2521cc16c938', class: CSS.column, role: "group" }, h("span", { key: '117e2b1eca1cd8ee8b5f79a9cfc0b003e165967d', "aria-label": this.messages.hourUp, class: {
                [CSS.button]: true,
                [CSS.buttonHourUp]: true,
                [CSS.buttonTopLeft]: true,
            }, onClick: this.hourUpClickHandler, role: "button" }, h("calcite-icon", { key: 'd1dfd48891fb26a56873ec597ec9822b2ae9cf5e', icon: "chevron-up", scale: iconScale })), h("span", { key: '2f299ba278f86107a2ef4a34fbe8fb5d9ec05f51', "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
                [CSS.input]: true,
                [CSS.hour]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setHourEl }, this.localizedHour || "--"), h("span", { key: '72bf35a4c3152282cdac87a9bb636dbed52652b4', "aria-label": this.messages.hourDown, class: {
                [CSS.button]: true,
                [CSS.buttonHourDown]: true,
                [CSS.buttonBottomLeft]: true,
            }, onClick: this.hourDownClickHandler, role: "button" }, h("calcite-icon", { key: '70f55cec6f85950079520f710f4bb1a76589bd90', icon: "chevron-down", scale: iconScale }))), h("span", { key: '93641650ddbbe9a0c8753034e4b4418a4dd6f33b', class: CSS.delimiter }, this.localizedHourSuffix), h("div", { key: '197cebdb724341cd763ed0a58f7c10090621fac0', class: CSS.column, role: "group" }, h("span", { key: '10a3705875f07b57c4f494af7ef2d81581985242', "aria-label": this.messages.minuteUp, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteUp]: true,
            }, onClick: this.minuteUpClickHandler, role: "button" }, h("calcite-icon", { key: '601b4929b942735034e37b634aac614a6640c209', icon: "chevron-up", scale: iconScale })), h("span", { key: '7ef20135cd182c3794c1ce9f7309b09804903171', "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
                [CSS.input]: true,
                [CSS.minute]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setMinuteEl }, this.localizedMinute || "--"), h("span", { key: '5c9f8d832d0e1e06b8f637fceaac7209aab6d58d', "aria-label": this.messages.minuteDown, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteDown]: true,
            }, onClick: this.minuteDownClickHandler, role: "button" }, h("calcite-icon", { key: 'ca3672e19d9dc9b9c4105144c5232d84b7489711', icon: "chevron-down", scale: iconScale }))), this.showSecond && h("span", { key: '5f484d639db6288275e213ceb5f0690a2752f618', class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (h("div", { key: 'd52bb3a7fdfa867bbccbe78d3279fb0ceb76a88b', class: CSS.column, role: "group" }, h("span", { key: '28436193da89813ac7f018e9455241bf4e2d07d0', "aria-label": this.messages.secondUp, class: {
                [CSS.button]: true,
                [CSS.buttonSecondUp]: true,
            }, onClick: this.secondUpClickHandler, role: "button" }, h("calcite-icon", { key: '839450a3d5330ba189d2d9e7ba66cf2618e632f2', icon: "chevron-up", scale: iconScale })), h("span", { key: '433feb864cc9f44ff7f6ffcaaef128f974a0634b', "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
                [CSS.input]: true,
                [CSS.second]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setSecondEl }, this.localizedSecond || "--"), h("span", { key: '808c3402b58419dd68e34274e560b670fdd1d1f0', "aria-label": this.messages.secondDown, class: {
                [CSS.button]: true,
                [CSS.buttonSecondDown]: true,
            }, onClick: this.secondDownClickHandler, role: "button" }, h("calcite-icon", { key: 'f09e4ac46e13232647e49f9038475f797e215497', icon: "chevron-down", scale: iconScale })))), this.showFractionalSecond && (h("span", { key: 'f1043c1c34a7c9296994ff2cb63fb5b8f00a14b8', class: CSS.delimiter }, this.localizedDecimalSeparator)), this.showFractionalSecond && (h("div", { key: '9c19c935c10e46b54c60c02e701952bd398c7e33', class: CSS.column, role: "group" }, h("span", { key: '0f59c173041cfdf3820982e8d7dd8ed829a543ce', "aria-label": this.messages.fractionalSecondUp, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondUp]: true,
            }, onClick: this.fractionalSecondUpClickHandler, role: "button" }, h("calcite-icon", { key: 'cd94cfecf478a52536c58252ead83ed41d65bb69', icon: "chevron-up", scale: iconScale })), h("span", { key: '0d494152f7b11714127f811e41c33d77010b2bbb', "aria-label": this.messages.fractionalSecond, "aria-valuemax": "999", "aria-valuemin": "1", "aria-valuenow": (fractionalSecondIsNumber && parseInt(this.fractionalSecond)) || "0", "aria-valuetext": this.localizedFractionalSecond, class: {
                [CSS.input]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setFractionalSecondEl }, this.localizedFractionalSecond || "--"), h("span", { key: '424ee367ab5ee7c6715d32cff9edbc47e6c964a6', "aria-label": this.messages.fractionalSecondDown, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondDown]: true,
            }, onClick: this.fractionalSecondDownClickHandler, role: "button" }, h("calcite-icon", { key: '91c71ca8891cb44a07a38cef3b144f170d1dc264', icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (h("span", { key: '43066eb805fff853f88210ee4f17e2fbf5f9fb97', class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (h("div", { key: '866b964e1e08c9b46d4e5a943a1471c767394ca9', class: {
                [CSS.column]: true,
                [CSS.meridiemStart]: this.meridiemOrder === 0,
            }, role: "group" }, h("span", { key: '2b0046366a6784fa6ff99be3a3c5370b6a5c01d9', "aria-label": this.messages.meridiemUp, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemUp]: true,
                [CSS.buttonTopRight]: true,
            }, onClick: this.meridiemUpClickHandler, role: "button" }, h("calcite-icon", { key: '0c5fae03afd08adc4a3065ce595195610d23f96d', icon: "chevron-up", scale: iconScale })), h("span", { key: '148c4d7b777999d1fe2ca5937f16dfca61fcfd8c', "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
                [CSS.input]: true,
                [CSS.meridiem]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setMeridiemEl }, this.localizedMeridiem || "--"), h("span", { key: 'ee470559d0034555ba1f2a26199e54326d728b6a', "aria-label": this.messages.meridiemDown, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemDown]: true,
                [CSS.buttonBottomRight]: true,
            }, onClick: this.meridiemDownClickHandler, role: "button" }, h("calcite-icon", { key: '093408bb889d14238bfb2987db200e7d223addfa', icon: "chevron-down", scale: iconScale }))))));
    }
    static get delegatesFocus() { return true; }
    static get assetsDirs() { return ["assets"]; }
    get el() { return getElement(this); }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-e39bfd2b.js.map