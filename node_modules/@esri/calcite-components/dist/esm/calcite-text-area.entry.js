 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, f as forceUpdate, H as Host, g as getElement } from './index-084e6474.js';
import { c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-4b51b128.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-43c2e846.js';
import { t as toAriaBoolean, b as slotChangeHasAssignedElement } from './dom-8c012086.js';
...
import { b as componentLoaded, s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-d76fe6f4.js';
...
const TextArea = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd457e39960155acef2958e6ed809b1a3ac334028' }, h(InteractiveContainer, { key: 'a3bfe30414830e1a793ab7e8231a126e6963906f', disabled: this.disabled }, h("textarea", { key: '9280d823986f44fd3f37db84f929422682e08c87', "aria-describedby": this.guid, "aria-invalid": toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": getLabelText(this), autofocus: this.el.autofocus, class: {
            ...
            ref: this.setTextAreaEl }), h("span", { key: '67ad3b8be9f7a1da183a9a8f05d40557691f5b6d', class: { [CSS.content]: true } }, h("slot", { key: '598e54e3b4e6fb108b641e5d50888adcb1593005', onSlotchange: this.contentSlotChangeHandler })), h("footer", { key: '70160fd9f9288f8befc82cca7b772b565b2ff657', class: {
                [CSS.footer]: true,
                [CSS.readOnly]: this.readOnly,
                [CSS.hide]: !hasFooter,
            },
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: (el) => (this.footerEl = el) }, h("div", { key: 'f278301adeb9a8906b42f1b16ac0557abcb51eca', class: {
                [CSS.container]: true,
                [CSS.footerEndSlotOnly]: !this.startSlotHasElements && this.endSlotHasElements,
            } }, h("slot", { key: '859857da2ed571c082b308e8208597e0abbf086a', name: SLOTS.footerStart, onSlotchange: (event) => (this.startSlotHasElements = slotChangeHasAssignedElement(event)) }), h("slot", { key: 'fa96f64697076dc3c2a2e0941a01e427ea553e0c', name: SLOTS.footerEnd, onSlotchange: (event) => (this.endSlotHasElements = slotChangeHasAssignedElement(event)) })), this.renderCharacterLimit()), h(HiddenFormInputSlot, { key: '2dcd561348977e56afe823f9ecc00d88fa25d112', component: this }), this.isCharacterLimitExceeded() && (h("span", { key: 'f2d28c3a4c40751a0336b8837de48eaa0e1efa98', "aria-hidden": true, "aria-live": "polite", class: CSS.assistiveText, id: this.guid }, this.replacePlaceHoldersInMessages())), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
