 ...
 * v2.8.5
 */
import { r as registerInstance, h, F as Fragment, g as getElement, c as createEvent, f as forceUpdate } from './index-084e6474.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-9aa0829a.js';
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, e as getSlotted, g as getElementDir, l as isPrimaryPointerButton } from './dom-8c012086.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-3bacb738.js';
import { c as clamp } from './math-400a5b13.js';
...
const Shell = class {
    ...
    render() {
        return (h(Fragment, { key: 'ccbd1ae998a64d97d0233e0c029282174ae0e133' }, this.renderHeader(), this.renderMain(), this.renderFooter(), this.renderPositionedSlots()));
    }
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (h("div", { key: '082724bcccaca00d5f596f0942651d93eb253bb1', class: CSS$1.content }, h("slot", { key: 'a14fbda9f01f45fed3b0d9249d08ce2f9a05bacf' })));
        ...
        return h(Fragment, { key: '81f87809e3837c8e338f40d8838401fdb63febe9' }, children);
    }
    get el() { return getElement(this); }
};
