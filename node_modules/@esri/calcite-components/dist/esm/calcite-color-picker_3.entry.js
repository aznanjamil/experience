 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment } from './index-084e6474.js';
import { l as isPrimaryPointerButton, g as getElementDir, d as focusElement, i as getModeName } from './dom-8c012086.js';
...
import { r as remap, c as clamp$1, a as closeToRangeEdge } from './math-400a5b13.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-639aa12c.js';
import { C as CSSColorMode, n as normalizeHex, a as hexify, o as opacityToAlpha, b as alphaToOpacity, c as alphaCompatible, p as parseMode, d as normalizeColor, e as colorEqual, t as toNonAlphaMode, f as normalizeAlpha, g as toAlphaMode, j as isLonghandHex, i as isValidHex, r as rgbToHex, k as hexChar } from './utils-2917fb51.js';
import { t as throttle } from './throttle-71d97468.js';
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '5f347cb136350e7661b7b479ee86a16bb85414c3', disabled: this.disabled }, h("div", { key: '0294cbc1d16db228c22a2ae1bd061d9a683c1378', class: CSS$2.container }, h("div", { key: 'f7531da7e77293d52f5f8220443258e40f07f2d3', class: CSS$2.controlAndScope }, h("canvas", { key: '6738d5bc8ec0f77c01eaac72b6b89edeea39abd3', class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeColorFieldScope })), h("div", { key: '1d1e670478df18f1a8ad35d9ca217b378e103468', class: CSS$2.previewAndSliders }, h("calcite-color-picker-swatch", { key: 'e65dd58f2aebb184db914c3a2c4e9782eb4b1e7c', class: CSS$2.preview, color: selectedColorInHex, scale: "l" }), h("div", { key: '98fb46881b6c40899b8fdfa4afeb521356d1e250', class: CSS$2.sliders }, h("div", { key: '7367b44dcc87a8cfbd5cd913ebee690eeabfcb92', class: CSS$2.controlAndScope }, h("canvas", { key: '4fe31f39350ac02fe527452da248b07b573dadac', class: { [CSS$2.slider]: true, [CSS$2.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.initHueSlider }), h("div", { key: '47048d9a779471169b1c4ec14d70a1a258914b1a', "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: {
...
const ColorPickerHexInput = class {
    ...
    render() {
        ...
        return (h("div", { key: 'ce81e626a720cd37d45facd4ca1f9dd748df094c', class: CSS$1.container }, h("calcite-input-text", { key: 'a26b153eb8f2e9943106c515de68a5adeec24e2b', class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", scale: inputScale, value: hexInputValue,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
