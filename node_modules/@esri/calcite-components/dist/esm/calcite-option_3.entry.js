 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment, H as Host } from './index-084e6474.js';
import { c as createObserver } from './observers-128a4167.js';
import { d as focusElement } from './dom-8c012086.js';
...
const Option = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return h("slot", { key: '5da42b98d7f8d5a6036f9b2a4f45113752289d6d' }, this.label);
    }
...
const OptionGroup = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (h(Fragment, { key: '52990dfd78732b297a9693682994eac13de0ea6c' }, h("div", { key: 'f8907d01f123eb1f3df0055cafc6bba8d6067080' }, this.label), h("slot", { key: '393f15738c365072299d1b60be1408a5e86a95f3' })));
    }
    static get watchers() { return {
        "disabled": ["handlePropChange"],
        "label": ["handlePropChange"]
...
const Select = class {
    ...
    render() {
        const { disabled } = this;
        return (h(Host, { key: '86822f587da89633e725f5fe6426f588f367b266' }, h(InteractiveContainer, { key: '93d728f3ee9cee364d439d7af2eda096a93bee10', disabled: disabled }, h("div", { key: 'e399054306a1f62b920ffbd0276fcb2da35950ad', class: CSS.wrapper }, h("select", { key: '61e58c1f549ab066e6508efad18ec20a0629bb87', "aria-label": getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeSelectRef }, h("slot", { key: 'feae368c462d5562396458a434d6be9574236d20' })), this.renderChevron(), h(HiddenFormInputSlot, { key: '8c2ee60a5f1192b063ef0d190a44e4afbd8b66ca', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
