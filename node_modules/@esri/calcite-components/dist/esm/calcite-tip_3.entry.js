 ...
 * v2.8.5
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement } from './index-084e6474.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-9aa0829a.js';
import { e as getSlotted, g as getElementDir, t as toAriaBoolean } from './dom-8c012086.js';
...
const Tip = class {
    ...
    render() {
        return (h(Fragment, { key: '0c1a204f565a12f4e359f1c6c050258bf70c2b18' }, h("article", { key: '1e2ea801101e4280b0b073e780ef1db6f064856b', class: CSS$1.container }, this.renderHeader(), this.renderContent()), this.renderDismissButton()));
    }
...
const TipGroup = class {
    ...
    render() {
        return h("slot", { key: '1c37ce2b89bdd6c4e386dcaefbfd9aebcf91bd4c' });
    }
};
