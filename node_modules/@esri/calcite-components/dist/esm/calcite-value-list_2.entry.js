...
import { g as getItemIndex, m as mutationObserverCallback, d as deselectRemovedItems, a as deselectSiblingItems, s as selectSiblings, h as handleFilter, b as handleFilterEvent, c as getItemData, k as keyDownHandler, e as moveItemIndex, i as initialize, f as initializeObserver, j as handleInitialFilter, l as cleanUpObserver, n as calciteListFocusOutHandler, r as removeItem, o as calciteListItemChangeHandler, p as calciteInternalListItemValueChangeHandler, q as setUpItems, t as setFocus, L as List, I as ICON_TYPES$1, C as CSS$1, S as SLOTS$1 } from './resources-cbf7f7e5.js';
import { d as dragActive, a as disconnectSortableComponent, c as connectSortableComponent } from './sortableComponent-2da30159.js';
import { d as focusElement, e as getSlotted } from './dom-8c012086.js';
...
const ValueList = class {
    ...
    render() {
        return (h(List, { key: 'c212dc4be12b594c4cc69a8a368c523d3187c289', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
...
const ValueListItem = class {
    ...
    render() {
        return (h(Host, { key: '14e426411cb528504d9b0e89d4378b6c22664878', id: this.el.id || this.guid }, h(InteractiveContainer, { key: '75e7cf666c5aae3e62c21d9160083ca17c926c15', disabled: this.disabled }, this.renderHandle(), h("calcite-pick-list-item", { key: '9e82a64e2022bfb5c052112e9e804f98db8c45bb', description: this.description, deselectDisabled: this.deselectDisabled, disabled: this.disabled, label: this.label, metadata: this.metadata, nonInteractive: this.nonInteractive, onCalciteListItemChange: this.handleSelectChange, removable: this.removable, selected: this.selected, value: this.value,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
