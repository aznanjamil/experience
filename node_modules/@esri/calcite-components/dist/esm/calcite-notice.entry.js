...
import { h as setRequestedIcon, e as getSlotted } from './dom-8c012086.js';
...
import { K as KindIcons } from './resources-7bfb0035.js';
...
const Notice = class {
    ...
    render() {
        const { el } = this;
        const closeButton = (h("button", { key: 'd9a357639c0642a4d42f2f2355629f73df249d81', "aria-label": this.messages.close, class: CSS.close, onClick: this.close,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.closeButton = el) }, h("calcite-icon", { key: 'b4e41e831fec865817b05a5dce71a87fca960a27', icon: "x", scale: getIconScale(this.scale) })));
        const hasActionEnd = getSlotted(el, SLOTS.actionsEnd);
        return (h("div", { key: 'b43379f0a2af9bcf8996b9187aebaef9a4ddaee0', class: CSS.container,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, this.requestedIcon ? (h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }))) : null, h("div", { key: '49430154b557c731f7839ee5df9d99923a1a40be', class: CSS.content }, h("slot", { key: '7b79b569608fbe88a4ecdff6956880afecc0371e', name: SLOTS.title }), h("slot", { key: '4d829bfc1ecacd57d4141fac2f58c5ba7fd2401b', name: SLOTS.message }), h("slot", { key: '93ef84c9cef662ee0a4a16c779604cef85b2baa2', name: SLOTS.link })), hasActionEnd ? (h("div", { class: CSS.actionsEnd }, h("slot", { name: SLOTS.actionsEnd }))) : null, this.closable ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
