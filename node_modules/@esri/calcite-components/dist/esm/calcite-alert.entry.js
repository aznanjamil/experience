...
import { b as slotChangeHasAssignedElement, t as toAriaBoolean, e as getSlotted, h as setRequestedIcon } from './dom-8c012086.js';
...
import { N as NumberStringFormat, c as connectLocalized, d as disconnectLocalized } from './locale-3bacb738.js';
...
const Alert = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ea81bb8c414a682356d9c2a839df57b73fd4de1e', "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, role: role }, h("div", { key: '1be63a6bf505158a2df208e6815944713cf61283', class: {
                [CSS.container]: true,
            ...
            ref: this.setTransitionEl }, effectiveIcon && this.renderIcon(effectiveIcon), h("div", { key: '7ba8590dc6b9f30a321b777a9eb13d12fe24257c', class: CSS.textContainer }, h("slot", { key: 'd58da2c0c6348ccdfded0c374bd8d20fe9f137db', name: SLOTS.title }), h("slot", { key: '91638c47e6917271aa7c1171496bb409a6a944dd', name: SLOTS.message }), h("slot", { key: '15cc676155a80cc02534e47108478a8f5090a41c', name: SLOTS.link })), this.renderActionsEnd(), hasQueuedAlerts ? this.renderQueueCount() : null, this.renderCloseButton(), open && !queued && autoClose ? h("div", { class: CSS.dismissProgress }) : null)));
    }
    renderCloseButton() {
