...
import { t as toAriaBoolean, k as focusElementInGroup, d as focusElement } from './dom-8c012086.js';
import { f as filterComputedPlacements, c as connectFloatingUI, d as defaultMenuPlacement, a as disconnectFloatingUI, F as FloatingCSS, r as reposition } from './floating-ui-53bb7346.js';
...
import { i as isActivationKey } from './key-d339e1f0.js';
...
const Dropdown = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'aad82a6a5bce5a29f6c309bb9ff20911b3ec9482' }, h(InteractiveContainer, { key: 'b559473528a0142c058c6e6de499e981748e369c', disabled: this.disabled }, h("div", { key: '089a4a3e39800339c21e50f167c1154dd90f0194', class: "calcite-trigger-container", id: `${guid}-menubutton`, onClick: this.openCalciteDropdown, onKeyDown: this.keyDownHandler,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setReferenceEl }, h("slot", { key: '1a6ded94e643359a5d9a6168d3abe0db4d96d57e', "aria-controls": `${guid}-menu`, "aria-expanded": toAriaBoolean(open), "aria-haspopup": "menu", name: SLOTS.dropdownTrigger, onSlotchange: this.updateTriggers })), h("div", { key: '3c8a8fcda5b885baadd1aaaf2b8181b9dfd24ddf', "aria-hidden": toAriaBoolean(!open), class: "calcite-dropdown-wrapper",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setFloatingEl }, h("div", { key: '8c04cadcb38268f20386f9e80f519b99f702054e', "aria-labelledby": `${guid}-menubutton`, class: {
                ["calcite-dropdown-content"]: true,
                [FloatingCSS.animation]: true,
                [FloatingCSS.animationActive]: open,
            }, id: `${guid}-menu`, role: "menu",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setScrollerAndTransitionEl }, h("slot", { key: '92b1d20e253dc2253aa2f998076bf640e696ff91', onSlotchange: this.updateGroups }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
...
const DropdownItem = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: '10985dba962cc1582cc6b2896e1c274b21e1dc20', class: CSS.iconStart, flipRtl: iconFlipRtl === "start" || iconFlipRtl === "both", icon: this.iconStart, scale: getIconScale(this.scale) }));
        const contentNode = (h("span", { key: 'e72a06cc3d3f325ec8e0e8eff407dc9149b29b14', class: CSS.itemContent }, h("slot", { key: 'e8d4e201f5903a2811c642d441d4b33d20abd7b2' })));
        const iconEndEl = (h("calcite-icon", { key: 'fd15f4aea96916ffa674591adc6887dafccc8218', class: CSS.iconEnd, flipRtl: iconFlipRtl === "end" || iconFlipRtl === "both", icon: this.iconEnd, scale: getIconScale(this.scale) }));
        ...
        const { disabled } = this;
        return (h(Host, { key: '6cdbba40456cde099120c69e8b743db43a044279', "aria-checked": itemAria, "aria-label": !href ? label : "", role: itemRole, tabIndex: disabled ? -1 : 0 }, h(InteractiveContainer, { key: 'ad9f797dba175a65095cb209f0230043ca19247c', disabled: disabled }, h("div", { key: '6380f6b0db4dfada44886e8e003d6d973598b252', class: {
                [CSS.container]: true,
