 ...
 * v2.8.5
 */
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './index-084e6474.js';
import { c as calciteSize48 } from './core-2d4b669f.js';
import { f as filter } from './filter-20783e0e.js';
import { B as nodeListToArray, D as getElementWidth, E as getTextWidth, t as toAriaBoolean, e as getSlotted } from './dom-8c012086.js';
import { d as defaultMenuPlacement, f as filterComputedPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-53bb7346.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-4b51b128.js';
...
import { b as componentLoaded, c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-d76fe6f4.js';
...
import { g as getIconScale, c as componentOnReady } from './component-320e2e16.js';
import { V as Validation } from './Validation-18c00041.js';
import { d as debounce } from './debounce-9e43d6f3.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-9aa0829a.js';
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
    return (h("button", { "aria-label": label, class: CSS$3.button, disabled: disabled, key: key, onClick: onClick, tabIndex: -1, type: "button", 
...
const Combobox = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6f3800dd3e309251ed56cd9e0ba8826c71b5551e', onClick: this.comboboxFocusHandler }, h(InteractiveContainer, { key: 'cd96916c5a2bd5f6d9b4011859ff804c9d06001c', disabled: this.disabled }, h("div", { key: '2ccaa8432826a117b2179a1974018a96ea9a44d1', "aria-live": "polite", class: {
                wrapper: true,
        ...
        ], h("label", { key: '3fa3c37a83c7fe0a8a6be409cdf4c797b4b174dc', class: "screen-readers-only", htmlFor: `${inputUidPrefix}${guid}`, id: `${labelUidPrefix}${guid}` }, label), this.renderInput()), !readOnly && isClearable ? (h(XButton, { disabled: this.disabled, key: "close-button", label: this.messages.clear, scale: this.scale })) : null, !readOnly && this.renderChevronIcon()), h("ul", { key: 'b2376d24b07d17738da6d9d3463be5d4a79fdbc1', "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-multiselectable": "true", class: "screen-readers-only", id: `${listboxUidPrefix}${guid}`, role: "listbox", tabIndex: -1 }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), h(HiddenFormInputSlot, { key: '37a5a706bfa1847aa825985c25f59992691bf339', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const ComboboxItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a10ab7e95408a8cffef4f42d3b87ae98450489b9', "aria-hidden": "true" }, h(InteractiveContainer, { key: '091b8f1a3f713899a3f14c1c39a6fdb70abab7a2', disabled: disabled }, h("div", { key: '43d200730971b71b3030437885e6ab99c55b2ce6', class: `container scale--${this.scale}`, style: { "--calcite-combobox-item-spacing-indent-multiplier": `${depth}` } }, h("li", { key: '8de885b34e9bc6b53a30396d54cbcec488790dd7', class: classes, id: this.guid, onClick: this.itemClickHandler }, this.renderSelectIndicator(showDot, iconPath), this.renderIcon(iconPath), h("span", { key: 'daba9ce50923261dce8896a74d8204b1e922a638', class: "title" }, this.textLabel)), this.renderChildren()))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
