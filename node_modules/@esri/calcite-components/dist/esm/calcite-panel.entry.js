...
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-8c012086.js';
...
import { S as SLOTS$1 } from './resources-745d2c17.js';
...
import { S as SLOTS, C as CSS, I as ICONS } from './resources-8822919f.js';
...
const Panel = class {
    ...
    render() {
        ...
        const panelNode = (h("article", { key: 'c03a39a1d58126b861ce2a4f7610a20d8bee288d', "aria-busy": toAriaBoolean(loading), class: CSS.container, hidden: closed, tabIndex: closable ? 0 : -1,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setContainerRef }, this.renderHeaderNode(), this.renderContent(), this.renderFooterNode()));
        return (h(Host, { key: '0378ba8d08d9c802b21f3c8edd9926f759a6381c', onKeyDown: panelKeyDownHandler }, h(InteractiveContainer, { key: 'ada3c75b32686e450190e407d6c4855e7e1310eb', disabled: disabled }, loading ? h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
