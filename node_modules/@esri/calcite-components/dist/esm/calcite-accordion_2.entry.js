...
import { e as getSlotted, g as getElementDir, t as toAriaBoolean, a as closestElementCrossShadowBoundary } from './dom-8c012086.js';
...
const AccordionItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2a8a9685457badba7f65ffdfd19af5b70cf34643' }, h("div", { key: '8292e5656cbf6988a393feda67b5ce2d58972470', class: {
                [`icon-position--${this.iconPosition}`]: true,
                [`icon-type--${this.iconType}`]: true,
            } }, h("div", { key: 'f4d599c5b507eb96665e7a78da9442784b2fad98', class: { [CSS.header]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.renderActionsStart(), h("div", { key: '1cd561a12f82b7f74902bc408fc7f7c71425d269', "aria-controls": IDS.section, "aria-expanded": toAriaBoolean(this.expanded), class: CSS.headerContent, id: IDS.sectionToggle, onClick: this.itemHeaderClickHandler, role: "button", tabindex: "0" }, h("div", { key: '8e7d9d5eebc91cc7295a02b7c83ae432071d753b', class: CSS.headerContainer }, iconStartEl, h("div", { key: 'da5293604951860def82dd6267d21c3ef35470b0', class: CSS.headerText }, h("span", { key: '4332fceb39f2523a027e7840eb1b343a72677701', class: CSS.heading }, this.heading), description ? h("span", { class: CSS.description }, description) : null), iconEndEl), h("calcite-icon", { key: 'c736b96c135d2cd9b55e65c88f91ed4e02a8fc2b', class: CSS.expandIcon, icon: this.iconType === "chevron"
                ? "chevronDown"
                : this.iconType === "caret"
                    ? "caretDown"
                    : this.expanded
                        ? "minus"
                        : "plus", scale: getIconScale(this.scale) })), this.renderActionsEnd()), h("section", { key: 'b0dd6748d5d9397246c48467d143a84c2d232b50', "aria-labelledby": IDS.sectionToggle, class: CSS.content, id: IDS.section }, h("slot", { key: '4494db9599ecd2ec4dce7c34a54c445572954842' })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
