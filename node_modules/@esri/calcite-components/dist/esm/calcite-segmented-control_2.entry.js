...
import { g as getElementDir, t as toAriaBoolean } from './dom-8c012086.js';
import { a as afterConnectDefaultValueSet, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-4b51b128.js';
...
const SegmentedControl = class {
    ...
    render() {
        return (h(Host, { key: '1241947631795e70e18ad5f923ecaab81d75eae9', onClick: this.handleClick, role: "radiogroup" }, h("div", { key: '1e1172df2df7a6ecd307f2e927e4bc766b8a1418', class: CSS$1.itemWrapper }, h(InteractiveContainer, { key: '874fc408bafb73b99748769ec5d361848b1b1fff', disabled: this.disabled }, h("slot", { key: '629d9b015a690804e8548e4b50dde9ad4c3fa9b7' }), h(HiddenFormInputSlot, { key: '3fedcebb6e1fe5a8d5ef426d301f510e7c1fc4f3', component: this }))), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
...
const SegmentedControlItem = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b20e8835703f9dcd6d96a58ca47efe9e57f1ebc7', "aria-checked": toAriaBoolean(checked), "aria-label": value, role: "radio" }, h("label", { key: '850c35eb51158b2e3674587163bb77f4b30e554f', class: {
            ...
            } }, this.iconStart ? iconStartEl : null, h("slot", { key: '2f41ec01fab8c3e54e16d74b98f8d50d4e69018f' }, value), h("slot", { key: 'f969ea4b8fbcc0ab01052f5ffd103149540de08f', name: SLOTS.input }), this.iconEnd ? iconEndEl : null)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
