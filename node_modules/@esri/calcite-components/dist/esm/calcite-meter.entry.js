...
import { a as afterConnectDefaultValueSet, c as connectForm, d as disconnectForm } from './form-4b51b128.js';
import { g as getSupportedLocale, n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-3bacb738.js';
import { v as intersects } from './dom-8c012086.js';
    ...
    render() {
        ...
        const valueText = valueLabelType === "percent"
            ...
            : unitLabel
                ? textUnitLabel
                : undefined;
        return (h(Host, { key: '4d680b8b390c26c00418c1947db18379e9499319' }, h("div", { key: 'd1cc9301427c9ec89a606f269119b8f7cceb9970', "aria-label": label, "aria-valuemax": rangeLabelType === "percent" ? maxPercent : max, "aria-valuemin": rangeLabelType === "percent" ? minPercent : min, "aria-valuenow": valueLabelType === "percent" ? currentPercent : value, "aria-valuetext": valueText, class: {
                [CSS.container]: true,
