...
import { m as mutationObserverCallback, d as deselectRemovedItems, a as deselectSiblingItems, s as selectSiblings, h as handleFilter, b as handleFilterEvent, c as getItemData, k as keyDownHandler, i as initialize, f as initializeObserver, l as cleanUpObserver, j as handleInitialFilter, r as removeItem, o as calciteListItemChangeHandler, p as calciteInternalListItemValueChangeHandler, n as calciteListFocusOutHandler, q as setUpItems, t as setFocus, I as ICON_TYPES, L as List, u as SLOTS, v as CSS, w as ICONS, C as CSS$1, S as SLOTS$1 } from './resources-cbf7f7e5.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-9aa0829a.js';
import { e as getSlotted, t as toAriaBoolean } from './dom-8c012086.js';
import { H as Heading, c as constrainHeadingLevel } from './Heading-de8100c7.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-3bacb738.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-639aa12c.js';
import './browser-afd17c9c.js';
import './array-545869f0.js';
...
const PickList = class {
    ...
    render() {
        return h(List, { key: 'a0d80f1773d8607a5ce49062f89358b475b1e0b6', onKeyDown: this.keyDownHandler, props: this });
    }
...
const PickListGroup = class {
    ...
    render() {
        ...
        return (h(Fragment, { key: '6380a5a015cc5b2d7e41abdd74cf27eefec2c966' }, title ? (h(Heading, { class: CSS.heading, level: level }, title)) : null, h("slot", { key: 'db5d5d42699ec83085a91875a76e7aa82b29a0ed', name: SLOTS.parentItem }), h("section", { key: 'e9dc462160bed69c1362f3b0268e2bcc0c316ff9', class: sectionClasses }, h("slot", { key: '6230b773bae6f2f834c363db00185bd9fd0e5fca' }))));
    }
    get el() { return getElement(this); }
};
...
const PickListItem = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '0fe5f95f3d7cdef6b48161b17be4438fabdedb4c', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), h("label", { key: '590f9ede824896af0d67a3cf1c787717d99be358', "aria-label": label, class: CSS$1.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, tabIndex: 0,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (focusEl) => (this.focusEl = focusEl) }, h("div", { key: '31786370e21ca8f471cbf28f705565281c143da7', "aria-checked": toAriaBoolean(this.selected), class: CSS$1.textContainer, role: "menuitemcheckbox" }, h("span", { key: '99471ca36bdd459d27661ad6b5a4071fb81ca8b2', class: CSS$1.title }, label), description ? h("span", { class: CSS$1.description }, description) : null)), this.renderActionsEnd()));
    }
