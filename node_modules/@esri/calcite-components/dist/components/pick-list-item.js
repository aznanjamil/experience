...
const PickListItem = /*@__PURE__*/ proxyCustomElement(class PickListItem extends HTMLElement {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '0fe5f95f3d7cdef6b48161b17be4438fabdedb4c', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), h("label", { key: '590f9ede824896af0d67a3cf1c787717d99be358', "aria-label": label, class: CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, tabIndex: 0,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (focusEl) => (this.focusEl = focusEl) }, h("div", { key: '31786370e21ca8f471cbf28f705565281c143da7', "aria-checked": toAriaBoolean(this.selected), class: CSS.textContainer, role: "menuitemcheckbox" }, h("span", { key: '99471ca36bdd459d27661ad6b5a4071fb81ca8b2', class: CSS.title }, label), description ? h("span", { class: CSS.description }, description) : null)), this.renderActionsEnd()));
    }
