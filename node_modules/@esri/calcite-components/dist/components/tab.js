...
import { y as nodeListToArray } from './dom.js';
...
const Tab = /*@__PURE__*/ proxyCustomElement(class Tab extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '71074d2c26a860d7934fbd9b236f9a264ab3c34f', "aria-labelledby": this.labeledBy, id: id }, h("div", { key: '3fcf14f4aaddf9ad579c26c962ad75803febcea0', class: { [CSS.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, h("section", { key: 'ba967be2e5121636d81754ec959452160bc4bb0d', class: CSS.content }, h("slot", { key: 'fae921d6fe2ae713bddc83adacbcf7e418aa1b7c' })))));
    }
    connectedCallback() {
