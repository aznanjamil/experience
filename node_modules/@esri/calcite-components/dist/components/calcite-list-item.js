...
import { d as slotChangeHasAssignedElement, C as getFirstTabbable, a as getElementDir, t as toAriaBoolean } from './dom.js';
...
const ListItem = /*@__PURE__*/ proxyCustomElement(class ListItem extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '15651b0bef6af7db01d650ff74b732db28758292' }, h(InteractiveContainer, { key: 'a0a4c2b6587a5c173710235518bf97aafc7d3b2a', disabled: disabled }, h("div", { key: 'f4dceb92cd6164d4d5445a9977aebfa9ae4073ff', class: { [CSS.wrapper]: true, [CSS.wrapperBordered]: bordered } }, h("tr", { key: '105d3b31fde1dabc1b606b25e28f9f7535367503', "aria-expanded": openable ? toAriaBoolean(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": toAriaBoolean(selected), "aria-setsize": setSize, class: {
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.containerEl = el) }, this.renderDragHandle(), this.renderSelected(), this.renderOpen(), this.renderActionsStart(), this.renderContentContainer(), this.renderActionsEnd()), this.renderContentBottom()), h("div", { key: '2018e3a2e07547caca69c18ce58a3e19ae66b3e8', class: CSS.indent }, this.renderDefaultContainer()))));
    }
