...
const CalciteNavigationLogo$1 = /*@__PURE__*/ proxyCustomElement(class CalciteNavigationLogo extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'cd8a1c95e9c72a494942c09285db6ce4e554e6a1' }, h("a", { key: 'bcb1a269e0d6cde0969de9d822f1f98e689f826a', class: CSS.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { key: 'c028ae89a0e3ae62e90280e3646894e9ee70458b', alt: this.label || "", class: CSS.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
