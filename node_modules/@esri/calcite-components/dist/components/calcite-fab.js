...
const Fab = /*@__PURE__*/ proxyCustomElement(class Fab extends HTMLElement {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '4203fb6efbcb95a451ff7853fdb8e60f992f96ee', disabled: disabled }, h("calcite-button", { key: 'c54c4bf5ce9cdb1e443a576051be4bafd284536a', appearance: appearance === "solid" ? "solid" : "outline-fill", class: CSS.button, disabled: disabled, iconFlipRtl: iconFlipRtl ? "start" : null, iconStart: icon, kind: kind, label: label, loading: loading, round: true, scale: scale, title: title, type: "button", width: "auto",
