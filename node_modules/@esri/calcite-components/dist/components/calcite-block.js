...
const Block = /*@__PURE__*/ proxyCustomElement(class Block extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '8e984813d8283475171ad0b58bb77c6671da394c' }, h(InteractiveContainer, { key: '9757aa3d3d51eeca2eece6b7fcf1ed2bdbc9d4eb', disabled: this.disabled }, h("article", { key: '6722572eb61cf147e473bd237bff74bafde0af56', "aria-busy": toAriaBoolean(loading), class: {
                [CSS.container]: true,
            } }, headerNode, h("section", { key: '14a1118f4b8a7d3f8ddc063cbcd2ba062090973a', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content,
