...
const Switch = /*@__PURE__*/ proxyCustomElement(class Switch extends HTMLElement {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '3844964b46482e9b6e902c07eccf97264970f3de', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: 'c0028a5587e7d346ba4d0d7a214f649606f85e17', disabled: this.disabled }, h("div", { key: 'ff48a447bbe579ff1b3f104dea12e76c91cbcb88', "aria-checked": toAriaBoolean(this.checked), "aria-label": getLabelText(this), class: "container", role: "switch", tabIndex: 0,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setSwitchEl }, h("div", { key: '5b9f7b7dcab019e92d62c8ff18bf00068a286b36', class: "track" }, h("div", { key: '7d05ec0e24c81db645735a7d6e03163ec77a2230', class: "handle" })), h(HiddenFormInputSlot, { key: '191a29b812bb8e1f31f56a7a84d941a48fb80372', component: this })))));
    }
    get el() { return this; }
