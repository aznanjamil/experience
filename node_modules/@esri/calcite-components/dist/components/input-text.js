...
const InputText = /*@__PURE__*/ proxyCustomElement(class InputText extends HTMLElement {
    ...
    render() {
        ...
        const loader = (h("div", { key: '3ec4d8fc6ae7436c6086ad86720f1c72d9de48dd', class: CSS.loader }, h("calcite-progress", { key: '67595008bf888677b7d5d7c87552e1a50f4150aa', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: 'bcecf1bbde5f7f4e406c1ab5086eea1acba8cb9c', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputTextValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'cd3290a3f64344e5cfe6b16dd1ffff1251499ad3', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: '8fe4f4cb00f59dac67ef7c7b9b48e5126cf38e31', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const prefixText = h("div", { key: 'dced1c574af69b545b8110601378cb469a116094', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: '91a3117072c6c0ef67df4c8784b1e81a002dbe73', class: CSS.suffix }, this.suffixText);
        const childEl = (h("input", { key: '0c365313279ee7bd6ec9f5f9776262ea849e0402', "aria-label": getLabelText(this), autocomplete: this.autocomplete, autofocus: this.el.autofocus ? true : null, class: {
        ...
        return (h(Host, { key: '16c5db61c7b866dbc617430a72da693c678088af', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: 'a645d05104fd36be24d3b1c4a3f96ffe18742da5', disabled: this.disabled }, h("div", { key: '6e51fa8c007842480459eeb1669fb48500908a31', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.prefixText ? prefixText : null, h("div", { key: 'c5e8d14f2f707e26c5f9d4bca5c3b17e6d2d3a00', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: '3bc807289e5f477e96b191f858512ab6fe6bc6f2', class: CSS.actionWrapper }, h("slot", { key: 'bbcfcd54de5bcd90560109835b766f7747563951', name: SLOTS.action })), this.suffixText ? suffixText : null, h(HiddenFormInputSlot, { key: 'ad29ed06d9124d489d2825599d0697a8c37fcd7b', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
