...
const Stepper = /*@__PURE__*/ proxyCustomElement(class Stepper extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '00695fed43575595fcca8adac07588de79f14170', "aria-label": this.messages.label, role: "region" }, h("div", { key: '3b06715dc1220048bdab4743e783fb28a8da001e', class: { container: true, [CSS$1.singleView]: this.layout === "horizontal-single" },
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: this.setContainerEl }, this.layout === "horizontal-single" && (h("div", { key: 'd14afc0d2ae03ea603a5c3a05157825f3dcbcc43', class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), this.layout === "horizontal-single" && (h("div", { key: 'a83ca9efc86407ab66d895027ff3a6b9d4ab698f', class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), h("slot", { key: '104b16d7e23e4ec0977d2934906ea83ffcd7f4cc', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
