...
describe("calcite-popover", () => {
    ...
    it("should honor Enter key interaction", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-popover placement="auto" reference-element="ref">content</calcite-popover>
    ...
    it("should not toggle popovers when the ref element (component) is disabled", async () => {
        const page = await newE2EPage();
        await page.setContent(html ` <calcite-popover reference-element="ref"> Hello World</calcite-popover>
