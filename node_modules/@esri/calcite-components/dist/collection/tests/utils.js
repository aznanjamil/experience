 ...
 */
export async function assertSelectedItems(groupElementTagName, page, { expectedItemIds }) {
    await page.waitForTimeout(100);
    const selectedItemIds = await page.evaluate((groupElementTagName) => {
        const group = document.querySelector(groupElementTagName);
        return group.selectedItems.map((item) => item.id);
    }, groupElementTagName);
 ...
 * @param page - The E2EPage instance
 */
assertSelectedItems.setUpEvents = async (eventName, page) => {
