 ...
 */
export declare function assertSelectedItems(groupElementTagName: string, page: E2EPage, { expectedItemIds }: SelectedItemsAssertionOptions): Promise<void>;
export declare namespace assertSelectedItems {
    var setUpEvents: (eventName: string, page: E2EPage) => Promise<void>;
}
export {};
