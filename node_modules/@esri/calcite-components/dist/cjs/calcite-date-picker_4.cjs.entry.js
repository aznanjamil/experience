    ...
    render() {
        ...
        const maxDate = this.range && this.activeRange
            ? this.activeRange === "start"
                ...
                : this.maxAsDate
            : this.maxAsDate;
        return (index.h(index.Host, { key: 'af94b669a3045e53c100cb5850381e9f77423133', onBlur: this.resetActiveDates, onKeyDown: this.keyDownHandler }, this.renderCalendar(activeDate, maxDate, minDate, date, endDate)));
    }
...
const DatePickerDay = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8de3dbeb652bfeb5ea9e9a490c3cec6a3663aeea', "aria-disabled": dom.toAriaBoolean(this.disabled), "aria-label": dayLabel, "aria-selected": dom.toAriaBoolean(this.active), id: dayId, onClick: this.onClick, onKeyDown: this.keyDownHandler, role: "button", tabIndex: this.active && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: 'edb52f389027ea4f48067e2c0a4c6a28251bc4ab', disabled: this.disabled }, index.h("div", { key: 'fd75d2ebcd2e6ca21afdefb3f4e6f02089b43609', "aria-hidden": "true", class: { "day-v-wrapper": true } }, index.h("div", { key: 'd4ac04c544b7f26c1e1992f4b8046c608c6174cd', class: "day-wrapper" }, index.h("span", { key: '8453fd6dd54fa642f1779b99e2f1012a2277cfda', class: "day" }, index.h("span", { key: 'fb704e33e0d0af0ce76988983b530e640a361299', class: "text" }, formattedDay)))))));
    }
    connectedCallback() {
...
const DatePickerMonthHeader = class {
    ...
    render() {
        return index.h("div", { key: '9e392da76cbe365de812b6219b3ee7ada90a09e6', class: CSS.header }, this.renderContent());
    }
    renderContent() {
