...
const Action = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ea1d66de5f1b0d591306a8f40d1ce22c6b99a8cd' }, index.h(interactive.InteractiveContainer, { key: 'ac7794e91182528fa2729ecac860a1abe4fbaeec', disabled: disabled }, index.h("button", { key: '32d7d5461e68006e2baadf7f65e504fbf2f0f9a0', "aria-busy": dom.toAriaBoolean(loading), "aria-controls": indicator ? indicatorId : null, "aria-disabled": dom.toAriaBoolean(disabled), "aria-label": ariaLabel, "aria-pressed": dom.toAriaBoolean(active), class: buttonClasses, disabled: disabled, id: buttonId,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (buttonEl) => (this.buttonEl = buttonEl) }, this.renderIconContainer(), this.renderTextContainer(), !icon && indicator && index.h("div", { class: CSS.indicatorWithoutIcon, key: "indicator-no-icon" })), index.h("slot", { key: '5e4ba8c04428b6797dfdaaa8ca1e96d6bc8487a7', name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText())));
    }
