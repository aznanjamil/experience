    ...
    render() {
        ...
        const valueText = valueLabelType === "percent"
            ...
            : unitLabel
                ? textUnitLabel
                : undefined;
        return (index.h(index.Host, { key: '4d680b8b390c26c00418c1947db18379e9499319' }, index.h("div", { key: 'd1cc9301427c9ec89a606f269119b8f7cceb9970', "aria-label": label, "aria-valuemax": rangeLabelType === "percent" ? maxPercent : max, "aria-valuemin": rangeLabelType === "percent" ? minPercent : min, "aria-valuenow": valueLabelType === "percent" ? currentPercent : value, "aria-valuetext": valueText, class: {
                [CSS.container]: true,
