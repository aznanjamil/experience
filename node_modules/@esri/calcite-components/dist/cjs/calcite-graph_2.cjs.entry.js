...
const Slider = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '86ec64bfb42495e7fc927751ad7d2a667b0a625d', id: id, onKeyDown: this.handleKeyDown, onTouchStart: this.handleTouchStart }, index.h(interactive.InteractiveContainer, { key: '842aacebaf4199a088f71b2d2ad7420845cf2629', disabled: this.disabled }, index.h("div", { key: '364511c370bbf454958accdd4c3084a1c339de22', "aria-label": label.getLabelText(this), class: {
                [CSS.container]: true,
                [CSS.containerRange]: valueIsRange,
                [`scale--${this.scale}`]: true,
            } }, this.renderGraph(), index.h("div", { key: 'b382bc88c07796d339dd972bcea3459ce8664de9', class: CSS.track,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeTrackRef }, index.h("div", { key: 'ba6aeb6fca50edd0c2d13077a49ac00f0aa93cf3', class: CSS.trackRange, onPointerDown: this.onTrackPointerDown, style: trackRangePlacementStyles }), index.h("div", { key: '013d292f6046b456443c9537facac8a6a2b1c4e6', class: CSS.ticks }, this.tickValues.map((tick) => {
        ...
        }))), index.h("div", { key: '31e1150688ac0371ed3b32a839c855b79ae9ed47', class: CSS.thumbContainer }, minThumb, thumb, index.h(form.HiddenFormInputSlot, { key: '3de3bb38e26cd71ee3a49541d61534b004ff137b', component: this }))))));
    }
