...
const resources = require('./resources-48a6fbd5.js');
...
const ActionMenu = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '172df111e58778a1006253a0eb444e767ad2d12b' }, this.renderMenuButton(), this.renderMenuItems(), index.h("slot", { key: '1df982aa86cbdd0c2c7d847e9b6f0a4d35b5ba15', name: resources.SLOTS.tooltip, onSlotchange: this.updateTooltip })));
    }
