...
const List = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'be7d5300b720d3c2adb29ee3dec27d7b70c3e0b4', disabled: this.disabled }, index.h("div", { key: '1c6ff5516994d00848c331174d07ab4c7a70d5a1', class: CSS$1.container }, this.dragEnabled ? (index.h("span", { "aria-live": "assertive", class: CSS$1.assistiveText }, this.assistiveText)) : null, this.renderItemAriaLive(), loading ? index.h("calcite-scrim", { class: CSS$1.scrim, loading: loading }) : null, index.h("table", { key: '78bfe1d34ec213e8f0c5494784298ff67d39ec8c', "aria-busy": dom.toAriaBoolean(loading), "aria-label": label || "", class: CSS$1.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? (index.h("thead", { class: CSS$1.sticky }, index.h("tr", null, index.h("th", { colSpan: MAX_COLUMNS }, index.h("calcite-stack", { class: CSS$1.stack }, index.h("slot", { name: SLOTS.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: resources.SLOTS.actionsStart }), index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, value: filterText,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setFilterEl }), index.h("slot", { name: SLOTS.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: resources.SLOTS.actionsEnd })))))) : null, index.h("tbody", { key: '8950cb148789530e6dad16a722c7c6077b2a5ab8', class: CSS$1.tableContainer }, index.h("slot", { key: 'a8333193d984d6534f5861a1cee0cd98744573b6', onSlotchange: this.handleDefaultSlotChange }))), index.h("div", { key: '2b96f30d61ac1d33e6709afe93ce259b61d1ab67', "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, index.h("slot", { key: '12c5d5758a840ef8eb9cbc5df36b73ec7a8f3c94', name: SLOTS.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange })))));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
...
const ListItem = class {
    ...
    renderDragHandle() {
        ...
        return dragHandle ? (index.h("td", { "aria-label": label, class: CSS$2.dragContainer, key: "drag-handle-container", onFocusin: this.focusCellHandle, role: "gridcell",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
    ...
    renderActionsStart() {
        ...
        return (index.h("td", { "aria-label": label, class: CSS$2.actionsStart, hidden: !hasActionsStart, key: "actions-start-container", onFocusin: this.focusCellActionsStart, role: "gridcell",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
    ...
    renderActionsEnd() {
        ...
        return (index.h("td", { "aria-label": label, class: CSS$2.actionsEnd, hidden: !(hasActionsEnd || closable), key: "actions-end-container", onFocusin: this.focusCellActionsEnd, role: "gridcell",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.actionsEndEl = el) }, index.h("slot", { name: SLOTS$1.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }), closable ? (index.h("calcite-action", { appearance: "transparent", icon: ICONS.close, key: "close-action", label: messages.close, onClick: this.handleCloseClick, text: messages.close })) : null));
    }
    renderContentStart() {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '15651b0bef6af7db01d650ff74b732db28758292' }, index.h(interactive.InteractiveContainer, { key: 'a0a4c2b6587a5c173710235518bf97aafc7d3b2a', disabled: disabled }, index.h("div", { key: 'f4dceb92cd6164d4d5445a9977aebfa9ae4073ff', class: { [CSS$2.wrapper]: true, [CSS$2.wrapperBordered]: bordered } }, index.h("tr", { key: '105d3b31fde1dabc1b606b25e28f9f7535367503', "aria-expanded": openable ? dom.toAriaBoolean(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": dom.toAriaBoolean(selected), "aria-setsize": setSize, class: {
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.containerEl = el) }, this.renderDragHandle(), this.renderSelected(), this.renderOpen(), this.renderActionsStart(), this.renderContentContainer(), this.renderActionsEnd()), this.renderContentBottom()), index.h("div", { key: '2018e3a2e07547caca69c18ce58a3e19ae66b3e8', class: CSS$2.indent }, this.renderDefaultContainer()))));
    }
...
const ListItemGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aced6e7f4e0f88658a55973c6451bd3ade9a1095' }, index.h(interactive.InteractiveContainer, { key: '6a7e77734cc737dfc7779c38f958e23ad19da06a', disabled: disabled }, index.h("tr", { key: '702a28ae4b478501503ab647fc46c33f25c1e8f7', class: CSS.container }, index.h("td", { key: '24f50d9130578bbac482ad2dce2777c962f19cc2', class: CSS.heading, colSpan: MAX_COLUMNS }, heading)), index.h("slot", { key: '67ff643701086e093115a93eca5cdb3e1c6559d5', onSlotchange: this.handleDefaultSlotChange }))));
    }
    get el() { return index.getElement(this); }
};
