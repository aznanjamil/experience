...
const Carousel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e26fac48bb322e4d33ae1074c83ca4f83da24649' }, index.h(interactive.InteractiveContainer, { key: 'ecdc547a3127f58eaec10677281a34ad895f6d5e', disabled: this.disabled }, index.h("div", { key: '99b501c010c01559c943290cc026bbab193ede57', "aria-label": this.label, "aria-live": this.playing ? "off" : "polite", "aria-roledescription": this.messages.carousel, class: {
            ...
            // eslint-disable-next-line react/jsx-sort-props
            ref: this.storeContainerRef }, index.h("section", { key: '4a6b4483dd82a0e8e374ad48c41c8dac826d681e', class: {
            ...
            ref: this.storeItemContainerRef }, index.h("slot", { key: '4c3e1b8181f21348339e42a0e08ba87985220ee7', onSlotchange: this.handleSlotChange })), this.items.length > 1 && this.renderPaginationArea(), this.arrowType === "edge" && this.renderArrow("previous"), this.arrowType === "edge" && this.renderArrow("next")))));
    }
