    ...
    render() {
        ...
        const role = this.selectionMode === "multiple"
            ...
            : this.selectionMode !== "none"
                ? "radio"
                : undefined;
        return (index.h(index.Host, { key: '8fa8f2d7e3ff03d01d746fd00236958a910cc60b' }, index.h(interactive.InteractiveContainer, { key: 'f1a65dcd2389a060c9de2ab0d9ee9b4ab23609f9', disabled: this.disabled }, index.h("div", { key: '093dc24588252efa9ce7f58cbd6791f9010ab9b9', "aria-checked": this.selectionMode !== "none" ? dom.toAriaBoolean(this.selected) : undefined, "aria-disabled": this.disabled, "aria-label": this.label, class: { [CSS.contentWrapper]: true, inline: thumbnailInline }, onClick: this.cardBodyClickHandler, onKeyDown: this.keyDownHandler, role: role, tabIndex: !this.selectable || this.disabled ? 0 : -1,
            // eslint-disable-next-line react/jsx-sort-props
            ref: (el) => (this.containerEl = el) }, this.loading ? (index.h("div", { "aria-live": "polite", class: "calcite-card-loader-container" }, index.h("calcite-loader", { label: this.messages.loading }))) : null, thumbnailStart && this.renderThumbnail(), index.h("section", { key: 'efe0f6b35e6e4ed6ceacd4e9d0e7879e9527e331', "aria-busy": dom.toAriaBoolean(this.loading), class: { [CSS.container]: true } }, this.renderHeader(), index.h("div", { key: 'd74667dc72d6320d3d97ff6b386f1659d53174f5', class: {
                [CSS.cardContent]: true,
                [CSS.hasSlottedContent]: this.hasContent,
            } }, index.h("slot", { key: 'dbcd8cb5f7979f33a93810dd38124b10c8174b43', onSlotchange: this.handleDefaultSlotChange })), this.renderFooter()), !thumbnailStart && this.renderThumbnail()))));
    }
