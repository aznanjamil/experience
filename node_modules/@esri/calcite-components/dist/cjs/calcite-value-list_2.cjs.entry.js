...
const ValueList = class {
    ...
    render() {
        return (index.h(resources.List, { key: 'c212dc4be12b594c4cc69a8a368c523d3187c289', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
...
const ValueListItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '14e426411cb528504d9b0e89d4378b6c22664878', id: this.el.id || this.guid }, index.h(interactive.InteractiveContainer, { key: '75e7cf666c5aae3e62c21d9160083ca17c926c15', disabled: this.disabled }, this.renderHandle(), index.h("calcite-pick-list-item", { key: '9e82a64e2022bfb5c052112e9e804f98db8c45bb', description: this.description, deselectDisabled: this.deselectDisabled, disabled: this.disabled, label: this.label, metadata: this.metadata, nonInteractive: this.nonInteractive, onCalciteListItemChange: this.handleSelectChange, removable: this.removable, selected: this.selected, value: this.value,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
