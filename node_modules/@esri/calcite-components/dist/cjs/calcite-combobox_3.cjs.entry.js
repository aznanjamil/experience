...
const core = require('./core-2ee14e3c.js');
const filter = require('./filter-ad657c3d.js');
...
const conditionalSlot = require('./conditionalSlot-fd9d4b06.js');
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
    return (index.h("button", { "aria-label": label, class: CSS$3.button, disabled: disabled, key: key, onClick: onClick, tabIndex: -1, type: "button", 
...
const Combobox = class {
    ...
    renderInput() {
        ...
        return (index.h("span", { class: {
            ...
            }, key: "label" }, selectedItem.textLabel)), index.h("input", { "aria-activedescendant": this.activeDescendant, "aria-autocomplete": "list", "aria-controls": `${listboxUidPrefix}${guid}`, "aria-expanded": dom.toAriaBoolean(open), "aria-haspopup": "listbox", "aria-label": label.getLabelText(this), "aria-owns": `${listboxUidPrefix}${guid}`, class: {
                [CSS$2.input]: true,
                "input--single": true,
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6f3800dd3e309251ed56cd9e0ba8826c71b5551e', onClick: this.comboboxFocusHandler }, index.h(interactive.InteractiveContainer, { key: 'cd96916c5a2bd5f6d9b4011859ff804c9d06001c', disabled: this.disabled }, index.h("div", { key: '2ccaa8432826a117b2179a1974018a96ea9a44d1', "aria-live": "polite", class: {
                wrapper: true,
        ...
        ], index.h("label", { key: '3fa3c37a83c7fe0a8a6be409cdf4c797b4b174dc', class: "screen-readers-only", htmlFor: `${inputUidPrefix}${guid}`, id: `${labelUidPrefix}${guid}` }, label), this.renderInput()), !readOnly && isClearable ? (index.h(XButton, { disabled: this.disabled, key: "close-button", label: this.messages.clear, scale: this.scale })) : null, !readOnly && this.renderChevronIcon()), index.h("ul", { key: 'b2376d24b07d17738da6d9d3463be5d4a79fdbc1', "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-multiselectable": "true", class: "screen-readers-only", id: `${listboxUidPrefix}${guid}`, role: "listbox", tabIndex: -1 }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), index.h(form.HiddenFormInputSlot, { key: '37a5a706bfa1847aa825985c25f59992691bf339', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const ComboboxItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a10ab7e95408a8cffef4f42d3b87ae98450489b9', "aria-hidden": "true" }, index.h(interactive.InteractiveContainer, { key: '091b8f1a3f713899a3f14c1c39a6fdb70abab7a2', disabled: disabled }, index.h("div", { key: '43d200730971b71b3030437885e6ab99c55b2ce6', class: `container scale--${this.scale}`, style: { "--calcite-combobox-item-spacing-indent-multiplier": `${depth}` } }, index.h("li", { key: '8de885b34e9bc6b53a30396d54cbcec488790dd7', class: classes, id: this.guid, onClick: this.itemClickHandler }, this.renderSelectIndicator(showDot, iconPath), this.renderIcon(iconPath), index.h("span", { key: 'daba9ce50923261dce8896a74d8204b1e922a638', class: "title" }, this.textLabel)), this.renderChildren()))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ComboboxItemGroup = class {
    ...
    render() {
        ...
        return (index.h("ul", { key: 'f97f7287323229be32779d451a7e816b016c02b4', "aria-labelledby": this.guid, class: { [CSS.list]: true, [`scale--${scale}`]: true }, role: "group" }, index.h("li", { key: 'e7aa9b0a2955562d9687c294b3b39eafbd04c5a2', class: { [CSS.label]: true }, id: this.guid, role: "presentation", style: { "--calcite-combobox-item-spacing-indent-multiplier": `${depth}` } }, index.h("span", { key: '5b02b92d24c05a93a5aeeda140f7422c50fb52b0', class: CSS.title }, this.label)), index.h("slot", { key: '1a2e106d97304df29b2cbf5841e65726e55960ae' })));
    }
    get el() { return index.getElement(this); }
};
