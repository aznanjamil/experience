...
const Tile = class {
    ...
    renderTile() {
        ...
        return (index.h("div", { "aria-checked": selectionMode !== "none" && interactive ? dom.toAriaBoolean(this.selected) : undefined, "aria-disabled": disableInteraction ? dom.toAriaBoolean(disabled) : undefined, "aria-label": role && this.label, class: {
            ...
            ref: this.setContainerEl }, this.renderSelectionIcon(), index.h("div", { class: CSS.column }, index.h("slot", { name: SLOTS.contentTop }), icon && index.h("calcite-icon", { flipRtl: iconFlipRtl, icon: icon, scale: "l" }), index.h("div", { class: { [CSS.contentContainer]: true, [CSS.row]: true } }, index.h("slot", { name: SLOTS.contentStart }), index.h("div", { class: CSS.textContent }, heading && index.h("div", { class: CSS.heading }, heading), description && index.h("div", { class: CSS.description }, description)), index.h("slot", { name: SLOTS.contentEnd })), index.h("slot", { name: SLOTS.contentBottom }))));
    }
    render() {
        const { disabled } = this;
        return (index.h(interactive.InteractiveContainer, { key: '0498410835d5fc00d19eb6787aa89862ce784c46', disabled: disabled }, !!this.href ? (index.h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
