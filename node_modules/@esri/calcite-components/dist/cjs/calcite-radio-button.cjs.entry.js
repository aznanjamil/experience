...
const array = require('./array-684eca0e.js');
...
const RadioButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7f7f0cfa7e4a873346af37a4c90885e3b0353da9', onClick: this.clickHandler, onKeyDown: this.handleKeyDown }, index.h(interactive.InteractiveContainer, { key: 'a4896cb1e1444133c974769bd17adb62dd71f93b', disabled: this.disabled }, index.h("div", { key: '4efbe11beea96f535bbe5a0d4bb560c0c1771059', "aria-checked": dom.toAriaBoolean(this.checked), "aria-label": label.getLabelText(this), class: CSS.container, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, role: "radio", tabIndex: tabIndex,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setContainerEl }, index.h("div", { key: '4f5a058df72d81bb149d95e0bf86a43067818bbd', class: "radio" })), index.h(form.HiddenFormInputSlot, { key: '8760ce6ccca0a98c46f6198753f57509cbbe2551', component: this }))));
    }
