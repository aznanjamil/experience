...
const Tree = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4526caaeb8c36baa64c82db9587686515acddc5f', "aria-multiselectable": this.child
                ? undefined
                : (this.selectionMode === "multiple" || this.selectionMode === "multichildren").toString(), onKeyDown: this.keyDownHandler, role: !this.child ? "tree" : undefined, tabIndex: this.getRootTabIndex() }, index.h("slot", { key: '87a2923ef212db797f3930774bdf599849e57848' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const TreeItem = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '310a4c99bf0c59f24438ee4fe15f1656ec2915dc', class: CSS.iconStart, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: 'c2d3bdc257ea4dd48a70f3f772c34d7dae4babda', "aria-expanded": this.hasChildren ? dom.toAriaBoolean(isExpanded) : undefined, "aria-hidden": dom.toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem", tabIndex: this.disabled ? -1 : 0 }, index.h(interactive.InteractiveContainer, { key: 'a046b7d8eeb3f031e51a327c42e5fe7a07447d66', disabled: this.disabled }, index.h("div", { key: '041720f725fba77e2cd66b55302f8ccdbca55c31', class: { [CSS.itemExpanded]: isExpanded } }, index.h("div", { key: '1c1fb1516c603b62e47baa58057729570f6b7241', class: CSS.nodeAndActionsContainer }, index.h("div", { key: '4478aba838af86c101b9b1128f126e781d9cfcd9', class: {
                [CSS.nodeContainer]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, "data-selection-mode": this.selectionMode,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.defaultSlotWrapper = el) }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), index.h("div", { key: '92f2b681550c0f9498d7018d213cb43006911f2c', class: CSS.actionsEnd, hidden: !hasEndActions,
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: (el) => (this.actionSlotWrapper = el) }, slotNode)), index.h("div", { key: 'aa8712d646423483dc48c17fc191e65090cdbb8c', class: {
                [CSS.childrenContainer]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, role: this.hasChildren ? "group" : undefined }, index.h("slot", { key: '71e4d19c4b3694918ff0b1e14929fc0fd75bc154', name: SLOTS.children }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
