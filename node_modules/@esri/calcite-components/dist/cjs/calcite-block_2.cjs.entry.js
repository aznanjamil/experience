...
const Heading = require('./Heading-4c79bb70.js');
...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (index.h("header", { key: 'aefae50b975f87b21c9b37f7eae2df49062ee5f8', class: CSS$1.header, id: IDS$1.header }, this.renderIcon(), this.renderTitle()));
        ...
        const headerNode = (index.h("div", { key: 'f8c5ce075f5d83e483ee3d2d62fd187fd0987b30', class: CSS$1.headerContainer }, this.dragHandle ? index.h("calcite-handle", { label: heading }) : null, collapsible ? (index.h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? dom.toAriaBoolean(open) : null, class: CSS$1.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, index.h("calcite-icon", { "aria-hidden": "true", class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" }))) : (headerContent), hasControl ? (index.h("div", { class: CSS$1.controlContainer }, index.h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (index.h("calcite-action-menu", { label: messages.options, overlayPositioning: this.overlayPositioning }, index.h("slot", { name: SLOTS.headerMenuActions }))) : null));
        return (index.h(index.Host, { key: '8e984813d8283475171ad0b58bb77c6671da394c' }, index.h(interactive.InteractiveContainer, { key: '9757aa3d3d51eeca2eece6b7fcf1ed2bdbc9d4eb', disabled: this.disabled }, index.h("article", { key: '6722572eb61cf147e473bd237bff74bafde0af56', "aria-busy": dom.toAriaBoolean(loading), class: {
                [CSS$1.container]: true,
            } }, headerNode, index.h("section", { key: '14a1118f4b8a7d3f8ddc063cbcd2ba062090973a', "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content,
...
const BlockSection = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '76e223811594d99984f6e110e430725030574d83' }, headerNode, index.h("section", { key: '336e2701112e69eefb0461fbb8052d70a73b16fb', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content }, index.h("slot", { key: '3bd4125a763c91c22065162c5d5a1e2ee8d2f931' }))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
