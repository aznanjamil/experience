...
const Handle = class {
    ...
    render() {
        ...
        index.h("span", { key: '985ea19917a01e2fc366466d13909b297afa4b19', "aria-checked": this.disabled ? null : dom.toAriaBoolean(this.selected), "aria-disabled": this.disabled ? dom.toAriaBoolean(this.disabled) : null, "aria-label": this.disabled ? null : this.getAriaText("label"), class: { [CSS.handle]: true, [CSS.handleSelected]: !this.disabled && this.selected }, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown,
            ...
            } }, index.h("calcite-icon", { key: 'd904676f59997c1a673979adf1b58af369883eb3', icon: ICONS.drag, scale: "s" })));
    }
