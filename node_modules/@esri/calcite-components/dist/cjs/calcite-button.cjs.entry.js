...
const Button = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: '45941adf90ef50fe1aa5ed4a874dc8a841f4b16f', class: { [CSS.icon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { key: 'dcd2f544410e55c7dc3a277f9c5c04da0c00b041', class: { [CSS.icon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        const contentEl = (index.h("span", { key: 'f69134d138dab0649abf8dda9ad85f129746dded', class: CSS.content,
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: (el) => (this.contentEl = el) }, index.h("slot", { key: '0012a57d49d94c50e9fdc9eceb4b4395dfa1424b' })));
        return (index.h(interactive.InteractiveContainer, { key: 'fae594988f9fd052100e50250ac09621066e1cc8', disabled: this.disabled }, index.h(Tag, { key: 'afb4ffda9526e954612e2edc2ccee94bc459478a', "aria-disabled": childElType === "a" ? dom.toAriaBoolean(this.disabled || this.loading) : null, "aria-expanded": this.el.getAttribute("aria-expanded"), "aria-label": !this.loading ? label.getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
