...
const utils = require('./utils-ccc6f751.js');
const dom = require('./dom-b0fff076.js');
const floatingUi = require('./floating-ui-922e03ca.js');
...
require('./debounce-710ef088.js');
require('./browser-9a8dadbd.js');
require('./observers-15e0ba11.js');
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fd558a11028d7d967811f2a1236d46e82d45161b', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'ebf90902c5f3056147f91ee4690e6e69ab452042', disabled: this.disabled }, this.localeData && (index.h("div", { key: '5e5cfbb9688e08aaf1e12b3527882ee3911d8e84', class: CSS.inputContainer }, index.h("div", { key: '63014b5695465c3a1b4fe54be6f036a1aa8393e8', class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setStartWrapper }, index.h("calcite-input-text", { key: '5cfeff37fb1998954f4e17296f15fcf6b9ea10cd', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, index.h("calcite-date-picker", { key: 'e9a771765f104b79391396ead9d7e359aa0325cb', activeDate: this.datePickerActiveDate, activeRange: this.focusedInput, headingLevel: this.headingLevel, max: this.max, maxAsDate: this.maxAsDate, messageOverrides: this.messageOverrides, min: this.min, minAsDate: this.minAsDate, numberingSystem: numberingSystem, onCalciteDatePickerChange: this.handleDateChange, onCalciteDatePickerRangeChange: this.handleDateRangeChange, proximitySelectionDisabled: this.proximitySelectionDisabled, range: this.range, scale: this.scale, tabIndex: this.open ? undefined : -1, valueAsDate: this.valueAsDate,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setDatePickerRef }))), this.range && this.layout === "horizontal" && (index.h("div", { key: '61b5787f2990d8143bf62da9e33e1253ab196a47', class: CSS.horizontalArrowContainer }, index.h("calcite-icon", { key: 'c665d2196d7cc71535ae1e352729ad7c3eb606e6', flipRtl: true, icon: "arrow-right", scale: component.getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (index.h("div", { key: '3b5b05e60ad4dc6e866f2a2e3b8da8427e0d8769', class: CSS.verticalArrowContainer }, index.h("calcite-icon", { key: '395db3f34af565b7403ce50a1455833a43a86463', icon: "arrow-down", scale: component.getIconScale(this.scale) }))), this.range && (index.h("div", { key: '596548166a4798cbd04ee76938a5a5e8ae2a9081', class: CSS.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setEndWrapper }, index.h("calcite-input-text", { key: '1d56b70f902730c20cd0d501d5ece75635bd503b', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "end"))))), index.h(form.HiddenFormInputSlot, { key: '7f09766af52aaa2db452431301dfa55cd8af3a2e', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
