...
const dom = require('./dom-b0fff076.js');
...
const locale = require('./locale-e33b9145.js');
const observers = require('./observers-15e0ba11.js');
const resources = require('./resources-a870a585.js');
...
const input = require('./input-2810f46d.js');
require('./guid-5445985f.js');
require('./browser-9a8dadbd.js');
...
const Input = class {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: 'b8611c67559682fd64ded80a0beddbd052f6fe2f', class: CSS.loader }, index.h("calcite-progress", { key: '84c686cba5249dae749bb44955e9a213cbed4943', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: 'a87ff81e4d8c269d2a223c773f7d5c0fb0216690', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '2f88616c3cc07201c049d25ee032bd819d1f14f1', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: '536bc3560e1cb98bc9ec48c88396bf947b5ec341', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (index.h("button", { key: 'f1aa09c7c05fbc66df54e8e655f2fbad0e8b962c', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '12b3fd28215d661525be63f614411287aa08e0fb', icon: "chevron-up", scale: component.getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (index.h("button", { key: '3e57ba83119f351060ed012fe4332a56dfd991d4', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'daf34d239d12e945aa623ed5b36e8d17e9a2e5d6', icon: "chevron-down", scale: component.getIconScale(this.scale) })));
        const numberButtonsVertical = (index.h("div", { key: '7301bb025d47c2137cfed412c1fb576fed9a2095', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = index.h("div", { key: '11dc889ef37e67ee0f0f73e54b7ce27eef7d88be', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: 'ddb9a1f7ebae815d2cf0d3c79ba3703f244c1c84', class: CSS.suffix }, this.suffixText);
        ...
        const localeNumberInput = this.type === "number" ? (index.h("input", { accept: this.accept, "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: autofocus, defaultValue: this.defaultValue, disabled: this.disabled ? true : null, enterKeyHint: enterKeyHint, inputMode: inputMode, key: "localized-input", maxLength: this.maxLength, minLength: this.minLength, multiple: this.multiple, name: undefined, onBlur: this.inputBlurHandler, onFocus: this.inputFocusHandler, onInput: this.inputNumberInputHandler, onKeyDown: this.inputNumberKeyDownHandler, onKeyUp: this.inputKeyUpHandler, pattern: this.pattern, placeholder: this.placeholder || "", readOnly: this.readOnly, type: "text", value: this.displayedValue,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setChildNumberElRef })) : null;
        const childEl = this.type !== "number"
            ? [
                index.h(this.childElType, { accept: this.accept, "aria-label": label.getLabelText(this), autocomplete: this.autocomplete, autofocus: autofocus, class: {
            ...
            : null;
        return (index.h(index.Host, { key: 'd85f76e488d456eb0a7c2ae9bc7daf195463409a', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '3289a4cad3353bf744476144c493b25b2fd21e55', disabled: this.disabled }, index.h("div", { key: '70c56455cf02bff933428c63499a4c05d49849e7', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, index.h("div", { key: 'a6d9a32e41dd867c9f2284a16c55188c3d8024c7', class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: 'dff205b764e3f8818a3ff8b2e68fbad387aab0b1', class: CSS.actionWrapper }, index.h("slot", { key: '1d10788964cace3ea9f87db3b67f1d51a174218d', name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
            ? numberButtonsVertical
            : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, index.h(form.HiddenFormInputSlot, { key: 'f551976332e2fb77ed861b2d744e67939e88c211', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
