...
const browser = require('./browser-9a8dadbd.js');
require('./dom-b0fff076.js');
...
const Table = class {
    ...
    renderTHead() {
        return (index.h("thead", null, index.h("slot", { name: SLOTS.tableHeader, onSlotchange: this.updateRows,
    ...
    renderTBody() {
        return (index.h("tbody", null, index.h("slot", { onSlotchange: this.updateRows,
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: (el) => (this.tableBodySlotEl = el) })));
    }
    renderTFoot() {
        return (index.h("tfoot", null, index.h("slot", { name: SLOTS.tableFooter, onSlotchange: this.updateRows,
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: (el) => (this.tableFootSlotEl = el) })));
    }
    render() {
        return (index.h(index.Host, { key: 'ef7ccc8c38ffa6a1f2168194360d210d95c93586' }, index.h("div", { key: '5e6c5971b1175ea268c863b394295024d27b30da', class: CSS.container }, this.selectionMode !== "none" && this.renderSelectionArea(), index.h("div", { key: '668438589e52c53f20d9a9c97fd732bb5a423175', class: {
                [CSS.bordered]: this.bordered,
                [CSS.striped]: this.striped || this.zebra,
                [CSS.tableContainer]: true,
            } }, index.h("table", { key: 'c8b35b353d207b4eab3a973a242e38c67642bba3', "aria-colcount": this.colCount, "aria-multiselectable": this.selectionMode === "multiple", "aria-rowcount": this.allRows?.length, class: { [CSS.tableFixed]: this.layout === "fixed" }, role: this.interactionMode === "interactive" ? "grid" : "table" }, index.h("caption", { key: '1f5b24d93dc5a715f946e38e3dde002b7ba614ff', class: CSS.assistiveText }, this.caption), this.renderTHead(), this.renderTBody(), this.renderTFoot())), this.pageSize > 0 && this.renderPaginationArea())));
    }
