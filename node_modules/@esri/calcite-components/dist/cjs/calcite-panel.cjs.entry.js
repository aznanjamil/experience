...
const Panel = class {
    ...
    render() {
        ...
        const panelNode = (index.h("article", { key: 'c03a39a1d58126b861ce2a4f7610a20d8bee288d', "aria-busy": dom.toAriaBoolean(loading), class: resources.CSS.container, hidden: closed, tabIndex: closable ? 0 : -1,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setContainerRef }, this.renderHeaderNode(), this.renderContent(), this.renderFooterNode()));
        return (index.h(index.Host, { key: '0378ba8d08d9c802b21f3c8edd9926f759a6381c', onKeyDown: panelKeyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'ada3c75b32686e450190e407d6c4855e7e1310eb', disabled: disabled }, loading ? index.h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
