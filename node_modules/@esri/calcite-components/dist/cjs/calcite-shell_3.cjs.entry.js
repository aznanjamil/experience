...
const Shell = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'ccbd1ae998a64d97d0233e0c029282174ae0e133' }, this.renderHeader(), this.renderMain(), this.renderFooter(), this.renderPositionedSlots()));
    }
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (index.h("div", { key: '082724bcccaca00d5f596f0942651d93eb253bb1', class: CSS$1.content }, index.h("slot", { key: 'a14fbda9f01f45fed3b0d9249d08ce2f9a05bacf' })));
        ...
        return index.h(index.Fragment, { key: '81f87809e3837c8e338f40d8838401fdb63febe9' }, children);
    }
    get el() { return index.getElement(this); }
};
