...
const utils = require('./utils-fad95fef.js');
const throttle = require('./throttle-0eb3e0d9.js');
...
const ColorPicker = class {
    ...
    handleValueChange(value, oldValue) {
        ...
        const color = isClearable && !value
            ? null
            : Color$1(value != null && typeof value === "object" && utils.alphaCompatible(this.mode)
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '5f347cb136350e7661b7b479ee86a16bb85414c3', disabled: this.disabled }, index.h("div", { key: '0294cbc1d16db228c22a2ae1bd061d9a683c1378', class: CSS$2.container }, index.h("div", { key: 'f7531da7e77293d52f5f8220443258e40f07f2d3', class: CSS$2.controlAndScope }, index.h("canvas", { key: '6738d5bc8ec0f77c01eaac72b6b89edeea39abd3', class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.initColorField }), index.h("div", { key: '932e10e761c6e8732e3412b049c895df18c4358f', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [CSS$2.scope]: true, [CSS$2.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeColorFieldScope })), index.h("div", { key: '1d1e670478df18f1a8ad35d9ca217b378e103468', class: CSS$2.previewAndSliders }, index.h("calcite-color-picker-swatch", { key: 'e65dd58f2aebb184db914c3a2c4e9782eb4b1e7c', class: CSS$2.preview, color: selectedColorInHex, scale: "l" }), index.h("div", { key: '98fb46881b6c40899b8fdfa4afeb521356d1e250', class: CSS$2.sliders }, index.h("div", { key: '7367b44dcc87a8cfbd5cd913ebee690eeabfcb92', class: CSS$2.controlAndScope }, index.h("canvas", { key: '4fe31f39350ac02fe527452da248b07b573dadac', class: { [CSS$2.slider]: true, [CSS$2.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.initHueSlider }), index.h("div", { key: '47048d9a779471169b1c4ec14d70a1a258914b1a', "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: {
            ...
            ref: this.storeOpacityScope }))) : null)), noHex && noChannels ? null : (index.h("div", { class: {
                ...
                [CSS$2.section]: true,
            } }, index.h("div", { class: CSS$2.hexAndChannelsGroup }, noHex ? null : (index.h("div", { class: CSS$2.hexOptions }, index.h("calcite-color-picker-hex-input", { allowEmpty: this.isClearable, alphaChannel: alphaChannel, class: CSS$2.control, messages: messages, numberingSystem: this.numberingSystem, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: scale, value: selectedColorInHex }))), noChannels ? null : (index.h("calcite-tabs", { class: {
...
const ColorPickerHexInput = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ce81e626a720cd37d45facd4ca1f9dd748df094c', class: CSS$1.container }, index.h("calcite-input-text", { key: 'a26b153eb8f2e9943106c515de68a5adeec24e2b', class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", scale: inputScale, value: hexInputValue,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
