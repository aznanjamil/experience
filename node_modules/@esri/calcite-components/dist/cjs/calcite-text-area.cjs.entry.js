...
const TextArea = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd457e39960155acef2958e6ed809b1a3ac334028' }, index.h(interactive.InteractiveContainer, { key: 'a3bfe30414830e1a793ab7e8231a126e6963906f', disabled: this.disabled }, index.h("textarea", { key: '9280d823986f44fd3f37db84f929422682e08c87', "aria-describedby": this.guid, "aria-invalid": dom.toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": label.getLabelText(this), autofocus: this.el.autofocus, class: {
            ...
            ref: this.setTextAreaEl }), index.h("span", { key: '67ad3b8be9f7a1da183a9a8f05d40557691f5b6d', class: { [CSS.content]: true } }, index.h("slot", { key: '598e54e3b4e6fb108b641e5d50888adcb1593005', onSlotchange: this.contentSlotChangeHandler })), index.h("footer", { key: '70160fd9f9288f8befc82cca7b772b565b2ff657', class: {
                [CSS.footer]: true,
                [CSS.readOnly]: this.readOnly,
                [CSS.hide]: !hasFooter,
            },
            // eslint-disable-next-line react/jsx-sort-props -- auto-generated by @esri/calcite-components/enforce-ref-last-prop
            ref: (el) => (this.footerEl = el) }, index.h("div", { key: 'f278301adeb9a8906b42f1b16ac0557abcb51eca', class: {
                [CSS.container]: true,
                [CSS.footerEndSlotOnly]: !this.startSlotHasElements && this.endSlotHasElements,
            } }, index.h("slot", { key: '859857da2ed571c082b308e8208597e0abbf086a', name: SLOTS.footerStart, onSlotchange: (event) => (this.startSlotHasElements = dom.slotChangeHasAssignedElement(event)) }), index.h("slot", { key: 'fa96f64697076dc3c2a2e0941a01e427ea553e0c', name: SLOTS.footerEnd, onSlotchange: (event) => (this.endSlotHasElements = dom.slotChangeHasAssignedElement(event)) })), this.renderCharacterLimit()), index.h(form.HiddenFormInputSlot, { key: '2dcd561348977e56afe823f9ecc00d88fa25d112', component: this }), this.isCharacterLimitExceeded() && (index.h("span", { key: 'f2d28c3a4c40751a0336b8837de48eaa0e1efa98', "aria-hidden": true, "aria-live": "polite", class: CSS.assistiveText, id: this.guid }, this.replacePlaceHoldersInMessages())), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
