...
const SplitButton = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '5bca9f9751e7f7ff1a4fb5bde5dd2cf8adeb039b', disabled: this.disabled }, index.h("div", { key: 'd8d95651c49144034a5356b045b39a9b80ed8778', class: CSS.container }, index.h("calcite-button", { key: 'd882eca49b2d32c0c366bac900c01b6f448e2af6', appearance: this.appearance, disabled: this.disabled, "icon-end": this.primaryIconEnd ? this.primaryIconEnd : null, "icon-start": this.primaryIconStart ? this.primaryIconStart : null, iconFlipRtl: this.primaryIconFlipRtl ? this.primaryIconFlipRtl : null, kind: this.kind, label: this.primaryLabel, loading: this.loading, onClick: this.calciteSplitButtonPrimaryClickHandler, scale: this.scale, splitChild: "primary", type: "button", width: buttonWidth }, this.primaryText), index.h("div", { key: '7756c7e247a7d74c94d635b7da4e23e25588ccdc', class: CSS.dividerContainer }, index.h("div", { key: 'b855b43e1338dd73b8f9fa27217843bb0e1bdf64', class: CSS.divider })), index.h("calcite-dropdown", { key: 'ab0fba71ae22c3af9563f99a5ac0feb51be0fb9f', disabled: this.disabled, onClick: this.calciteSplitButtonSecondaryClickHandler, open: this.active, overlayPositioning: this.overlayPositioning, placement: "bottom-end", scale: this.scale, "width-scale": this.scale }, index.h("calcite-button", { key: '6b94ce6f08d225bff2be6a3ece459e991436835d', appearance: this.appearance, disabled: this.disabled, "icon-start": this.dropdownIcon, kind: this.kind, label: this.dropdownLabel, scale: this.scale, slot: "trigger", splitChild: "secondary", type: "button" }), index.h("slot", { key: 'd7ddac81064109f923f0e871b59ff38128a17ab8' })))));
    }
    get dropdownIcon() {
