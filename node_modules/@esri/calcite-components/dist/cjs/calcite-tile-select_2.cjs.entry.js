...
const TileSelect = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'cb72da1fece66ab2a4c24aec61a924c81a3be406', disabled: disabled }, index.h("div", { key: 'f8abb79474c9939a05485a447fcd94754472eeaa', class: {
                checked,
                container: true,
            ...
            } }, index.h("div", { key: 'cada0a6b11dc4a65f0ae444445d39ae7e058f589', class: { [CSS.tile]: true, [CSS.tileLargeVisual]: isLargeVisual } }, icon && (index.h("div", { key: 'd26d5b02a707cb453d26ffeb41f1baf4c7f861bf', class: { [CSS.icon]: renderIcon } }, index.h("calcite-icon", { key: '690d7789c359fc50dff1382dffa134f4d338afa5', flipRtl: iconFlipRtl, icon: icon, scale: "l" }))), index.h("div", { key: 'c01eb4ce2a7904987f6af65334f3418ed46be72d', class: CSS.tileContentContainer }, index.h("div", { key: 'e6374efec4daf4330ea74e10f1490fa33a1231dd', class: CSS.tileContent }, heading && index.h("div", { key: '5790d802a61bac534ffe8dd095b14fb42f612154', class: CSS.tileHeading }, heading), description && index.h("div", { key: '7fca63ab5fe57d12d510bcc72a26fa8306628c57', class: CSS.tileDescription }, description)))), index.h("slot", { key: '6587a274607d033c86e7ece20004f755343f5f9d' }))));
    }
...
const TileSelectGroup = class {
    ...
    render() {
        return (index.h(interactive.InteractiveContainer, { key: 'eb2fc818dec5f2f97b4e19c4aabb7a2c6ca37bc2', disabled: this.disabled }, index.h("slot", { key: '4a421944031b9e192b4e51b02349be6ed9ed79ef' })));
    }
    get el() { return index.getElement(this); }
};
