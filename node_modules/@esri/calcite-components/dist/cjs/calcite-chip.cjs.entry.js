        ...
        const role = this.selectionMode === "multiple" && this.interactive
            ...
            : this.selectionMode !== "none" && this.interactive
                ...
                : this.interactive
                    ? "button"
                    : undefined;
        return (index.h(index.Host, { key: '6fde6f4666ca0c145936bcd6e8b1e27d2b7a45d8' }, index.h(interactive.InteractiveContainer, { key: '2cc3a9f9d8cc06757168f7ea1ecd5816f22d54a9', disabled: disabled }, index.h("div", { key: '30f6dd924ac68cfa614073dea661c214366987f7', "aria-checked": this.selectionMode !== "none" && this.interactive
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.containerEl = el) }, this.selectionMode !== "none" && this.renderSelectionIcon(), this.renderChipImage(), this.icon && this.renderIcon(), index.h("span", { key: 'e467f570503aea94f5ef464bd9ab7fd4d2c5fd9a', class: CSS.title }, index.h("slot", { key: 'f228540507f608f36288769a378a4bb73a7afeaf', onSlotchange: this.handleDefaultSlotChange })), this.closable && this.renderCloseButton()))));
    }
