...
const TableCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2c8bd5fb8909c57b46499b5fe8a525cdc46bb3c6' }, index.h(interactive.InteractiveContainer, { key: '1a7e4d12f5304274f9085e0f0db4b12ba41d51ed', disabled: this.disabled }, index.h("td", { key: '9a5868a78f21da3c9c0d6be7ecefd28c5e40e5c5', "aria-disabled": this.disabled, class: {
...
const TableHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8903d493aaa6fe46c1e7ee00814bc0d409fe05e4' }, index.h("th", { key: 'a8268eb7f5f7e272d9f228ee722ff09d2755fea7', "aria-colindex": this.parentRowType === "head" ? this.positionInRow : undefined, class: {
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.containerEl = el) }, this.heading && index.h("div", { key: '171a02cb89d9db736a4dda50b643e413e4de3828', class: CSS.heading }, this.heading), this.description && index.h("div", { key: '29fbf42a560ddcce82713de3003a70b67fd0c596', class: CSS.description }, this.description), this.selectionCell && this.selectionMode === "multiple" && (index.h("calcite-icon", { key: '232d1ac6051ad58768b94c5813e96357088b4c4a', class: { [CSS.active]: allSelected }, icon: selectionIcon, scale: component.getIconScale(this.scale) })), (this.selectionCell || this.numberCell) && (index.h("span", { key: 'f91e4e2de889f0c8397006470adb8b330d9c50d4', "aria-hidden": true, "aria-live": this.focused ? "polite" : "off", class: CSS.assistiveText }, this.screenReaderText)))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
