    ...
    if (mode === "offset") {
        if (!timeZoneGroups) {
            timeZoneGroups = Promise.all([
                Promise.resolve().then(function () { return require('./index-f4f83a58.js'); }),
                Promise.resolve().then(function () { return require('./index-158e9b08.js'); }),
            ]);
        }
...
const InputTimeZone = class {
    ...
    render() {
        ...
        })), index.h(form.HiddenFormInputSlot, { key: '9be196de8ecde0e10e293cd49b778ce52e75a131', component: this }))));
    }
