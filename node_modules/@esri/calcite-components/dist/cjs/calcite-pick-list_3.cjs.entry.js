...
const resources = require('./resources-7f2c9ee9.js');
...
const PickList = class {
    ...
    render() {
        return index.h(resources.List, { key: 'a0d80f1773d8607a5ce49062f89358b475b1e0b6', onKeyDown: this.keyDownHandler, props: this });
    }
...
const PickListGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '6380a5a015cc5b2d7e41abdd74cf27eefec2c966' }, title ? (index.h(Heading.Heading, { class: resources.CSS$1.heading, level: level }, title)) : null, index.h("slot", { key: 'db5d5d42699ec83085a91875a76e7aa82b29a0ed', name: resources.SLOTS$1.parentItem }), index.h("section", { key: 'e9dc462160bed69c1362f3b0268e2bcc0c316ff9', class: sectionClasses }, index.h("slot", { key: '6230b773bae6f2f834c363db00185bd9fd0e5fca' }))));
    }
    get el() { return index.getElement(this); }
};
...
const PickListItem = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '0fe5f95f3d7cdef6b48161b17be4438fabdedb4c', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), index.h("label", { key: '590f9ede824896af0d67a3cf1c787717d99be358', "aria-label": label, class: resources.CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, tabIndex: 0,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (focusEl) => (this.focusEl = focusEl) }, index.h("div", { key: '31786370e21ca8f471cbf28f705565281c143da7', "aria-checked": dom.toAriaBoolean(this.selected), class: resources.CSS.textContainer, role: "menuitemcheckbox" }, index.h("span", { key: '99471ca36bdd459d27661ad6b5a4071fb81ca8b2', class: resources.CSS.title }, label), description ? index.h("span", { class: resources.CSS.description }, description) : null)), this.renderActionsEnd()));
    }
