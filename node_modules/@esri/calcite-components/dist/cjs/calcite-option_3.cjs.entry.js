...
const Option = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return index.h("slot", { key: '5da42b98d7f8d5a6036f9b2a4f45113752289d6d' }, this.label);
    }
...
const OptionGroup = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (index.h(index.Fragment, { key: '52990dfd78732b297a9693682994eac13de0ea6c' }, index.h("div", { key: 'f8907d01f123eb1f3df0055cafc6bba8d6067080' }, this.label), index.h("slot", { key: '393f15738c365072299d1b60be1408a5e86a95f3' })));
    }
    static get watchers() { return {
        "disabled": ["handlePropChange"],
        "label": ["handlePropChange"]
...
const Select = class {
    ...
    render() {
        const { disabled } = this;
        return (index.h(index.Host, { key: '86822f587da89633e725f5fe6426f588f367b266' }, index.h(interactive.InteractiveContainer, { key: '93d728f3ee9cee364d439d7af2eda096a93bee10', disabled: disabled }, index.h("div", { key: 'e399054306a1f62b920ffbd0276fcb2da35950ad', class: CSS.wrapper }, index.h("select", { key: '61e58c1f549ab066e6508efad18ec20a0629bb87', "aria-label": label.getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeSelectRef }, index.h("slot", { key: 'feae368c462d5562396458a434d6be9574236d20' })), this.renderChevron(), index.h(form.HiddenFormInputSlot, { key: '8c2ee60a5f1192b063ef0d190a44e4afbd8b66ca', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
