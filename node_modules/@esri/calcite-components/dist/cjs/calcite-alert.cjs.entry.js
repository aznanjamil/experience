...
const Alert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ea81bb8c414a682356d9c2a839df57b73fd4de1e', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, role: role }, index.h("div", { key: '1be63a6bf505158a2df208e6815944713cf61283', class: {
                [CSS.container]: true,
            ...
            ref: this.setTransitionEl }, effectiveIcon && this.renderIcon(effectiveIcon), index.h("div", { key: '7ba8590dc6b9f30a321b777a9eb13d12fe24257c', class: CSS.textContainer }, index.h("slot", { key: 'd58da2c0c6348ccdfded0c374bd8d20fe9f137db', name: SLOTS.title }), index.h("slot", { key: '91638c47e6917271aa7c1171496bb409a6a944dd', name: SLOTS.message }), index.h("slot", { key: '15cc676155a80cc02534e47108478a8f5090a41c', name: SLOTS.link })), this.renderActionsEnd(), hasQueuedAlerts ? this.renderQueueCount() : null, this.renderCloseButton(), open && !queued && autoClose ? index.h("div", { class: CSS.dismissProgress }) : null)));
    }
    renderCloseButton() {
