...
const FloatingArrow = require('./FloatingArrow-8194a56e.js');
...
const Popover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9699189cce66b9eac663b521b33e0d74c07f271b', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, index.h("div", { key: 'ad5a31d83091be7486973e36f2e360fdd0cee060', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            },
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setTransitionEl }, arrowNode, index.h("div", { key: '4857f90f555b3b9057d39462f875265dbaa3cc7b', class: {
                [CSS.hasHeader]: !!heading,
                [CSS.container]: true,
            } }, this.renderHeader(), index.h("div", { key: 'a09083a06be92110adf34b178af162b387ccfb2f', class: CSS.content }, index.h("slot", { key: 'a9302486bd61e40e9d68a896965296d634f95f77' })), !heading ? this.renderCloseButton() : null))));
    }
