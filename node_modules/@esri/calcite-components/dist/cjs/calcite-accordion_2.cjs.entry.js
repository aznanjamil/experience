...
const Accordion = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '56df7ef7175fd9af4459626fb0d09aab4061e97d', class: {
                "accordion--transparent": transparent,
                accordion: !transparent,
            } }, index.h("slot", { key: 'a657cd0ddb7784909bb5a2df3648cda59d3e71e2' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const AccordionItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2a8a9685457badba7f65ffdfd19af5b70cf34643' }, index.h("div", { key: '8292e5656cbf6988a393feda67b5ce2d58972470', class: {
                [`icon-position--${this.iconPosition}`]: true,
                [`icon-type--${this.iconType}`]: true,
            } }, index.h("div", { key: 'f4d599c5b507eb96665e7a78da9442784b2fad98', class: { [CSS.header]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.renderActionsStart(), index.h("div", { key: '1cd561a12f82b7f74902bc408fc7f7c71425d269', "aria-controls": IDS.section, "aria-expanded": dom.toAriaBoolean(this.expanded), class: CSS.headerContent, id: IDS.sectionToggle, onClick: this.itemHeaderClickHandler, role: "button", tabindex: "0" }, index.h("div", { key: '8e7d9d5eebc91cc7295a02b7c83ae432071d753b', class: CSS.headerContainer }, iconStartEl, index.h("div", { key: 'da5293604951860def82dd6267d21c3ef35470b0', class: CSS.headerText }, index.h("span", { key: '4332fceb39f2523a027e7840eb1b343a72677701', class: CSS.heading }, this.heading), description ? index.h("span", { class: CSS.description }, description) : null), iconEndEl), index.h("calcite-icon", { key: 'c736b96c135d2cd9b55e65c88f91ed4e02a8fc2b', class: CSS.expandIcon, icon: this.iconType === "chevron"
                ? "chevronDown"
                : this.iconType === "caret"
                    ? "caretDown"
                    : this.expanded
                        ? "minus"
                        : "plus", scale: component.getIconScale(this.scale) })), this.renderActionsEnd()), index.h("section", { key: 'b0dd6748d5d9397246c48467d143a84c2d232b50', "aria-labelledby": IDS.sectionToggle, class: CSS.content, id: IDS.section }, index.h("slot", { key: '4494db9599ecd2ec4dce7c34a54c445572954842' })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
