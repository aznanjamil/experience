...
import { J as newWidgetsLegend, i as importCoreReactiveUtils } from './index-0bc55ca5.js';
import { r as referenceElementHelper, c as checkForView, a as addHandles } from './component-utils-23194f7c.js';
...
const ArcgisLegend = class {
    constructor(hostRef) {
        ...
        this.icon = undefined;
        this.respectLayerDefinitionExpression = false;
    ...
    respectLayerDefinitionExpressionWatcher(value) {
        if (value !== undefined && this.widget) {
            this.widget.respectLayerDefinitionExpression = value;
        }
    }
    ...
    _createParams() {
        ...
        if (this.respectLayerDefinitionExpression !== undefined) {
            params.respectLayerDefinitionExpression = this.respectLayerDefinitionExpression;
        }
    ...
    static get watchers() { return {
        ...
        "icon": ["iconWatcher"],
        "respectLayerDefinitionExpression": ["respectLayerDefinitionExpressionWatcher"],
