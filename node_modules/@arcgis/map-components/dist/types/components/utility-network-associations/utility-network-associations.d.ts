...
export declare class ArcgisUtilityNetworkAssociations implements WidgetElement {
    ...
    autoRefreshAssociationsWatcher(value: boolean): void;
    ...
    includeConnectivityAssociationsWatcher(value: boolean): void;
    includeStructuralAttachmentAssociations: boolean;
    includeStructuralAttachmentAssociationsWatcher(value: boolean): void;
    ...
    arcgisUtilityNetworkAssociationsReady: EventEmitter<void>;
