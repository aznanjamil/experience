...
import type { ArcgisReferenceElement, BaseComponentElement } from "../../utils/component-utils";
import type { ArcGISMapView, ArcGISSceneView } from "../types";
export declare class ArcgisPlacement implements BaseComponentElement {
    el: HTMLArcgisPlacementElement;
