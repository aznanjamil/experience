...
const ArcgisTimeSlider = class {
    constructor(hostRef) {
        ...
        this.arcgisTimeSliderReady = index.createEvent(this, "arcgisTimeSliderReady", 7);
        this.arcgisPropertyChange = index.createEvent(this, "arcgisPropertyChange", 7);
        this.timeSliderTriggerAction = index.createEvent(this, "timeSliderTriggerAction", 7);
        this._watchHandles = [];
