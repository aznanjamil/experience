...
const ArcgisBasemapToggle = class {
    constructor(hostRef) {
        ...
        this.arcgisBasemapToggleReady = index.createEvent(this, "arcgisBasemapToggleReady", 7);
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.activeBasemap, (value) => {
            this.activeBasemap = value;
            this.arcgisPropertyChange.emit({ name: "activeBasemap" });
        }, {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.nextBasemap, (value) => {
