...
const ArcgisValuePicker = class {
    constructor(hostRef) {
        ...
        this.arcgisValuePickerReady = index.createEvent(this, "arcgisValuePickerReady", 7);
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.canNext, (value) => (this.canNext = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.canPlay, (value) => (this.canPlay = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.canPrevious, (value) => (this.canPrevious = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.values, (value) => {
            this.values = value;
