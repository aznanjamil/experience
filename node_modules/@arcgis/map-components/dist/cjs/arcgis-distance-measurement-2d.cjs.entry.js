...
const ArcgisDistanceMeasurement2d = class {
    constructor(hostRef) {
        ...
        this.arcgisDistanceMeasurement2dReady = index.createEvent(this, "arcgisDistanceMeasurement2dReady", 7);
        this._watchHandles = [];
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsDistanceMeasurement2D(params);
        this.widget = widget;
...
exports.arcgis_distance_measurement_2d = ArcgisDistanceMeasurement2d;
