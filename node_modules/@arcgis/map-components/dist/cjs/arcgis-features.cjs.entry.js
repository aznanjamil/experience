...
const ArcgisFeatures = class {
    constructor(hostRef) {
        ...
        this.arcgisFeaturesReady = index.createEvent(this, "arcgisFeaturesReady", 7);
        this.arcgisPropertyChange = index.createEvent(this, "arcgisPropertyChange", 7);
        this.featuresTriggerAction = index.createEvent(this, "featuresTriggerAction", 7);
        this._watchHandles = [];
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsFeatures(params);
        this.widget = widget;
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.collapsed, (value) => (this.collapsed = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.promises, (value) => (this.promises = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.selectedFeature, (value) => {
            this.selectedFeature = value;
            this.arcgisPropertyChange.emit({ name: "selectedFeature" });
        }, {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.selectedFeatureIndex, (value) => {
