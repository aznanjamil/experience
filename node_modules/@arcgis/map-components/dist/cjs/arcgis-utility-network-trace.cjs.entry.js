...
const ArcgisUtilityNetworkTrace = class {
    constructor(hostRef) {
        ...
        this.arcgisUtilityNetworkTraceReady = index.createEvent(this, "arcgisUtilityNetworkTraceReady", 7);
        this.utilityNetworkTraceAddFlag = index.createEvent(this, "utilityNetworkTraceAddFlag", 7);
        this.utilityNetworkTraceAddFlagComplete = index.createEvent(this, "utilityNetworkTraceAddFlagComplete", 7);
        this.utilityNetworkTraceAddFlagError = index.createEvent(this, "utilityNetworkTraceAddFlagError", 7);
        this.utilityNetworkTraceAddResultArea = index.createEvent(this, "utilityNetworkTraceAddResultArea", 7);
        this.utilityNetworkTraceRemoveResultArea = index.createEvent(this, "utilityNetworkTraceRemoveResultArea", 7);
        this._watchHandles = [];
