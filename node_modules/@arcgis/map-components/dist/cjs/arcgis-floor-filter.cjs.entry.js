...
const ArcgisFloorFilter = class {
    constructor(hostRef) {
        ...
        this.arcgisFloorFilterReady = index.createEvent(this, "arcgisFloorFilterReady", 7);
        this._watchHandles = [];
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsFloorFilter(params);
        this.widget = widget;
...
exports.arcgis_floor_filter = ArcgisFloorFilter;
