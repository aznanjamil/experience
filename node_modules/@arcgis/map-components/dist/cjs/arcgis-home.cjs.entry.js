...
const index$1 = require('./index-dcd70450.js');
const index = require('./index-dbd85b3f.js');
...
class ViewModelController extends chunkWQTCUXBS.AccessorController {
    hostConnected() {
    ...
    _reEmitViewModelEvents() {
        ...
        Object.entries(this.component).forEach(([key, unknown]) => {
            ...
            const capitalizedEventName = index.kebabToPascal(trimmedEventName);
...
const proxy = chunkWQTCUXBS.proxyExports(ViewModelController);

// TODO: [MIGRATION] migrate tests
const css = {
    base: "esri-home",
};
const useHomeViewModel = makeViewModelController(index$2.newWidgetsHomeHomeViewModel);
const ArcgisHome = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.arcgisReady = index$1.createEvent(this, "arcgisReady", 7);
        this.viewModelGo = index$1.createEvent(this, "arcgisHomeGo", 7);
        //--------------------------------------------------------------------------
        //
        //  Controllers
        //
        ...
        this.messages = chunkWQTCUXBS.useT9n();
    ...
    render() {
        ...
        return (index$1.h("div", { class: index.classes(css.base, globalCss.widget) }, index$1.h("calcite-button", { class: globalCss.widgetButton, disabled: state === "disabled", "icon-start": isLoading ? undefined : icon, kind: "neutral", label: messages.componentLabel, onClick: this._go,
        ...
        index$1.h("calcite-loader", { inline: true, label: "" })) : null)));
    }
