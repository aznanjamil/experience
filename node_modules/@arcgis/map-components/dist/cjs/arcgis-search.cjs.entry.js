...
const disconnected = require('./disconnected-c825e309.js');
...
const ArcgisSearch = class {
    constructor(hostRef) {
        ...
        this.arcgisSearchReady = index.createEvent(this, "arcgisSearchReady", 7);
        ...
        this.searchSelectResult = index.createEvent(this, "searchSelectResult", 7);
        this.searchSuggestComplete = index.createEvent(this, "searchSuggestComplete", 7);
        this.searchSuggestStart = index.createEvent(this, "searchSuggestStart", 7);
        this._watchHandles = [];
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsSearch(params);
        this.widget = widget;
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.activeSource, (value) => (this.activeSource = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.activeSourceIndex, (value) => (this.activeSourceIndex = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.allSources, (value) => (this.allSources = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.defaultSources, (value) => (this.defaultSources = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.disabled, (value) => (this.disabled = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.resultGraphic, (value) => (this.resultGraphic = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.results, (value) => (this.results = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.selectedResult, (value) => (this.selectedResult = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.suggestions, (value) => (this.suggestions = value), {
            initial: true,
        }));
    }
    _createParams() {
