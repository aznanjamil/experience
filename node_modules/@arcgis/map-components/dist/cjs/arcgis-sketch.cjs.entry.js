...
const ArcgisSketch = class {
    constructor(hostRef) {
        ...
        this.arcgisSketchReady = index.createEvent(this, "arcgisSketchReady", 7);
        this.sketchCreate = index.createEvent(this, "sketchCreate", 7);
        this.sketchDelete = index.createEvent(this, "sketchDelete", 7);
        this.sketchRedo = index.createEvent(this, "sketchRedo", 7);
        this.sketchUndo = index.createEvent(this, "sketchUndo", 7);
        this.sketchUpdate = index.createEvent(this, "sketchUpdate", 7);
        this._watchHandles = [];
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsSketch(params);
        this.widget = widget;
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.activeTool, (value) => (this.activeTool = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.createGraphic, (value) => (this.createGraphic = value), {
            initial: true,
        }));
        componentUtils.addHandles(this, watch(() => this.widget.updateGraphics, (value) => (this.updateGraphics = value), {
            initial: true,
        }));
    }
    async _createParams() {
        ...
        this.layer || (this.layer = await index$1.newLayersGraphicsLayer(graphicsLayerProps));
        const params = {
            layer: this.layer,
        };
