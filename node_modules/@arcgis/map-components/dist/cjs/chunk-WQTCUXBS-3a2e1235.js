...
const index = require('./index-98f3aa83.js');
...
var ControllerManager = class extends GenericController {
  constructor(component) {
    ...
    const controllerHost = {
      ...
      requestUpdate: () => index$1.forceUpdate(component)
    };
...
exports.accessorInternals = accessorInternals;
exports.load = load;
