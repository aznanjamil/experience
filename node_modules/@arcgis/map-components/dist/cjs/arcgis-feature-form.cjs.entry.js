...
const ArcgisFeatureForm = class {
    constructor(hostRef) {
        ...
        this.featureFormSubmit = index.createEvent(this, "featureFormSubmit", 7);
        this.featureFormValueChange = index.createEvent(this, "featureFormValueChange", 7);
        this._watchHandles = [];
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsFeatureForm(params);
        this.widget = widget;
        this._proxyEvents();
