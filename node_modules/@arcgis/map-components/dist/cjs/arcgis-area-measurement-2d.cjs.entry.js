...
const ArcgisAreaMeasurement2d = class {
    constructor(hostRef) {
        ...
        this.arcgisAreaMeasurement2dReady = index.createEvent(this, "arcgisAreaMeasurement2dReady", 7);
        this._watchHandles = [];
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.unit, (value) => (this.unit = value), {
            initial: true,
        }));
...
exports.arcgis_area_measurement_2d = ArcgisAreaMeasurement2d;
