...
import { g as newWidgetsBookmarks, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisBookmarks$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisBookmarks extends HTMLElement {
    ...
    static get style() { return bookmarksCss; }
}, [0, "arcgis-bookmarks", {
        "referenceElement": [1, "reference-element"],
        "bookmarks": [16],
        "defaultCreateOptions": [16],
        "defaultEditOptions": [16],
        "disabled": [1540],
        "dragEnabled": [4, "drag-enabled"],
        "filterPlaceholder": [1, "filter-placeholder"],
        "filterText": [1, "filter-text"],
        "icon": [1],
        "visibleElementsAddBookmarkButton": [4, "visible-elements-add-bookmark-button"],
        ...
        "visibleElementsEditBookmarkButton": [4, "visible-elements-edit-bookmark-button"],
        ...
        "visibleElementsThumbnail": [4, "visible-elements-thumbnail"],
        "visibleElementsTime": [4, "visible-elements-time"],
        "position": [1],
        "view": [1040],
        "widget": [1040]
    }, undefined, {
