...
import { F as newWidgetsHistogramRangeSlider } from './index2.js';
...
const ArcgisHistogramRangeSlider$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisHistogramRangeSlider extends HTMLElement {
    ...
    static get style() { return histogramRangeSliderCss; }
}, [0, "arcgis-histogram-range-slider", {
        "referenceElement": [1, "reference-element"],
        "average": [2],
        "barCreatedFunction": [16],
        "bins": [16],
        "dataLineCreatedFunction": [16],
        "dataLines": [16],
        "excludedBarColor": [16],
        "includedBarColor": [16],
        "labelFormatFunction": [16],
        "max": [2],
        "min": [2],
        "precision": [2],
        "rangeType": [1, "range-type"],
        "standardDeviation": [2, "standard-deviation"],
        "standardDeviationCount": [2, "standard-deviation-count"],
        "values": [16],
        "position": [1],
        "expandable": [4],
        "widget": [1040]
...
function defineCustomElement$1() {
    ...
    const components = ["arcgis-histogram-range-slider", "arcgis-expand"];
