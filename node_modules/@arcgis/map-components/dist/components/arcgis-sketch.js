...
import { W as newWidgetsSketch, i as importCoreReactiveUtils, X as newLayersGraphicsLayer } from './index2.js';
...
const ArcgisSketch$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisSketch extends HTMLElement {
    ...
    static get style() { return sketchCss; }
        ...
        "tooltipOptions": [16],
        "updateGraphics": [1040],
        "visibleElementsCreateToolsPoint": [4, "visible-elements-create-tools-point"],
        "visibleElementsCreateToolsPolyline": [4, "visible-elements-create-tools-polyline"],
        "visibleElementsCreateToolsPolygon": [4, "visible-elements-create-tools-polygon"],
        "visibleElementsCreateToolsRectangle": [4, "visible-elements-create-tools-rectangle"],
        "visibleElementsCreateToolsCircle": [4, "visible-elements-create-tools-circle"],
        "visibleElementsDuplicateButton": [4, "visible-elements-duplicate-button"],
        "visibleElementsSelectionToolsRectangle": [4, "visible-elements-selection-tools-rectangle"],
        "visibleElementsSelectionToolsLasso": [4, "visible-elements-selection-tools-lasso"],
        "visibleElementsSettingsMenu": [4, "visible-elements-settings-menu"],
        ...
        "visibleElementsSnappingControlsElementsHeader": [4, "visible-elements-snapping-controls-elements-header"],
        "visibleElementsSnappingControlsElementsEnabledToggle": [4, "visible-elements-snapping-controls-elements-enabled-toggle"],
        "visibleElementsSnappingControlsElementsSelfEnabledToggle": [4, "visible-elements-snapping-controls-elements-self-enabled-toggle"],
        "visibleElementsSnappingControlsElementsFeatureEnabledToggle": [4, "visible-elements-snapping-controls-elements-feature-enabled-toggle"],
        "visibleElementsSnappingControlsElementsLayerList": [4, "visible-elements-snapping-controls-elements-layer-list"],
        "visibleElementsUndoRedoMenu": [4, "visible-elements-undo-redo-menu"],
        "position": [1],
        "view": [1040],
        "widget": [1040],
        "cancel": [64],
