...
import { o as newWidgetsDaylight } from './index2.js';
...
const ArcgisDaylight$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisDaylight extends HTMLElement {
    ...
    static get style() { return daylightCss; }
}, [0, "arcgis-daylight", {
        "referenceElement": [1, "reference-element"],
        "currentSeason": [1, "current-season"],
        "dayPlaying": [4, "day-playing"],
        "yearPlaying": [4, "year-playing"],
        "dateOrSeason": [1, "date-or-season"],
        "icon": [1],
        "playSpeedMultiplier": [2, "play-speed-multiplier"],
        "timeSliderSteps": [2, "time-slider-steps"],
        "visibleElementsHeader": [4, "visible-elements-header"],
        "visibleElementsPlayButtons": [4, "visible-elements-play-buttons"],
        "visibleElementsDatePicker": [4, "visible-elements-date-picker"],
        "visibleElementsTimezone": [4, "visible-elements-timezone"],
        "visibleElementsSunLightingToggle": [4, "visible-elements-sun-lighting-toggle"],
        "visibleElementsShadowsToggle": [4, "visible-elements-shadows-toggle"],
        "position": [1],
        "view": [1040],
        "widget": [1040]
    }, undefined, {
