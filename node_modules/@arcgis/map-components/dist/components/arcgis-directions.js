...
import { q as newLayersRouteLayer, r as newWidgetsDirections, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisDirections$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisDirections extends HTMLElement {
    ...
    static get style() { return directionsCss; }
}, [0, "arcgis-directions", {
        "referenceElement": [1, "reference-element"],
        "apiKey": [1, "api-key"],
        "icon": [1],
        "routeLayerItemId": [1, "route-layer-item-id"],
        "lastRoute": [1040],
        "layer": [16],
        "maxStops": [2, "max-stops"],
        "searchProperties": [16],
        "unit": [1],
        "useDefaultRouteLayer": [4, "use-default-route-layer"],
        "visibleElementsLayerDetails": [4, "visible-elements-layer-details"],
        "visibleElementsSaveAsButton": [4, "visible-elements-save-as-button"],
        "visibleElementsSaveButton": [4, "visible-elements-save-button"],
        "position": [1],
        "view": [1040],
        "widget": [1040],
        "getDirections": [64],
