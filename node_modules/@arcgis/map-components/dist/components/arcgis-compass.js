...
import { j as newWidgetsCompass, i as importCoreReactiveUtils } from './index2.js';
import { p as proxyExports, A as AccessorController, a as accessorInternals, u as useControllerManager, l as load, b as usePropertyChange } from './chunk-WQTCUXBS.js';
import { k as kebabToPascal } from './index3.js';
...
class WidgetController extends AccessorController {
    constructor(component, _loadAccessor) {
        ...
        Object.defineProperty(this.exports, "viewModel", {
            value: accessorInternals.makeGetterProxy(component, this._watchedViewModelProperties),
        });
    ...
    async hostLoad() {
        this.component.render = () => h("div", null);
        /*
        ...
        if (typeof viewModel === "object") {
            accessorInternals.watchComponentUpdates(this, viewModel, this._watchedViewModelProperties);
            accessorInternals.watchAccessorUpdates(this, viewModel, this._watchedViewModelProperties);
            const parameters = accessorInternals.gatherParameters(this, this._watchedViewModelProperties);
...
const useCompassWidget = makeWidgetController(newWidgetsCompass);
const __cmpMeta = [0,"arcgis-compass",{"icon":[1025],"label":[1025],"orientation":[1040],"position":[1025],"referenceElement":[1025,"reference-element"],"state":[1537],"reset":[64]}];
...
this.constructor.__registerControllers = ()=>__cmpMeta[2]??{};
        ...
        this.arcgisPropertyChange = usePropertyChange()("orientation");
    ...
    get el() { return this; }
    static get style() { return compassCss; }
}, __cmpMeta);
