...
import { a1 as newWidgetsTrack, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisTrack$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisTrack extends HTMLElement {
    ...
    static get style() { return trackCss; }
        ...
        "goToLocationEnabled": [4, "go-to-location-enabled"],
        "graphic": [16],
        "icon": [1],
        "positionFilterFunction": [16],
        "rotationEnabled": [4, "rotation-enabled"],
        "scale": [2],
        "state": [1537],
        "tracking": [1540],
        "position": [1],
