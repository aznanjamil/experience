...
import { w as newWidgetsFeature, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisFeature$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisFeature extends HTMLElement {
    constructor() {
        ...
        this.visibleElementsLastEditedInfo = true;
    ...
    async _addWatchers() {
        ...
        addHandles(this, watch(() => this.widget.view?.map, (value) => (this.map = value)));
    }
    _createParams() {
        const params = {};
        params.visibleElements = {
            ...
            lastEditedInfo: this.visibleElementsLastEditedInfo,
        };
    ...
    static get style() { return featureCss; }
        ...
        "defaultPopupTemplateEnabled": [4, "default-popup-template-enabled"],
        "graphic": [16],
        "location": [16],
        "map": [1040],
        "spatialReference": [16],
        "visibleElementsTitle": [4, "visible-elements-title"],
        "visibleElementsContentAttachments": [4, "visible-elements-content-attachments"],
        "visibleElementsContentFields": [4, "visible-elements-content-fields"],
        "visibleElementsContentMedia": [4, "visible-elements-content-media"],
        "visibleElementsContentText": [4, "visible-elements-content-text"],
        "visibleElementsContentExpression": [4, "visible-elements-content-expression"],
        "visibleElementsLastEditedInfo": [4, "visible-elements-last-edited-info"],
        "position": [1],
        "view": [1040],
        "widget": [1040],
        "nextMedia": [64],
