import type { IGeometry, GeometryType, IAttachmentInfo } from '@esri/arcgis-rest-feature-service'
...
export enum SupportedJSAPILayerTypes {
  ...
  GroupLayer = 'group',
  SceneLayer = 'scene',
  ImageryLayer = 'imagery', // dynamic imagery layer
  ImageryTileLayer = 'imagery-tile', // tiled imagery layer
...
interface JimuBuildingGroupSublayer extends __esri.BuildingGroupSublayer {
  parent: __esri.BuildingSceneLayer | JimuBuildingGroupSublayer
}

interface JimuBuildingSublayer extends __esri.BuildingSublayer {
  parent: __esri.BuildingSceneLayer | JimuBuildingGroupSublayer
}
 ...
 */
export type ArcGISSubLayer = __esri.Sublayer | __esri.KMLSublayer | __esri.WMSSublayer | __esri.WMTSSublayer | JimuBuildingSublayer
...
export interface JSAPILayerMixin {
   ...
   */
  createJSAPILayerByDataSource: (dataSource?: DataSource, useDataSourceQueryParams?: boolean, throwError?: boolean) => Promise<__esri.Layer>
