...
export type ArcGISQueriableLayerTypes = __esri.FeatureLayer | __esri.SceneLayer | __esri.OrientedImageryLayer | __esri.ImageryLayer

/**
 * `ArcGISQueriableDataSource` is created from a single feature layer, imagerLayer, orientedImageryLayer.
 */
...
export interface ArcGISSelectOptions extends QueriableSelectOptions {
  queryParams?: Pick<ArcGISQueryParams, 'where' | 'geometry'>
}
